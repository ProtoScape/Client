	...
	do {
		...
		if ((Class369_Sub2.anInt8587 ^ 0xffffffff) < -1) {
			...
			for (int i_43_ = 0; i_43_ < strings.length; i_43_++) {
			    ...
			    ClientApplet.p12fullFontRasterizer.drawString1(Class250.method1909((byte) 31, strings[i_43_]), -1, (-((-Class284.anInt3676 + i_41_) * Class68.anInt1188) + (-GraphicsFetcher.anInt9077 + heightOffset - (-350
					- (-2 + -(((BitmapFont)
