...
final class Class38
{
	...
	if (i_2_ == 1)
	    ...
	    ((Class38) this).anInt499 = class348_sub49.getWord(13638);
	    ((Class38) this).anInt502 = class348_sub49.getWord(13638);
	    ((Class38) this).anInt508 = class348_sub49.getWord(13638);
	} else if (i_2_ == 4)
	...
	if ((Class121.anInt1794 ^ 0xffffffff) != 0
		...
		if (!Class50_Sub1.aStringArray5223[i_4_].startsWith("pause")) {
		    ...
		    ClientApplet.addConsoleMessage("Pausing for " + i_5_ + " seconds...");
