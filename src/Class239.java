...
abstract class Class239
{
    ...
    static ServerPacket aClass114_3135 = new ServerPacket(108, 5);
    ...
    static ServerPacket aClass114_3143;
    static byte[] aByteArray3144 = new byte[520];
    static ServerPacket aClass114_3145;
	...
	Class348_Sub33.settingFlags = new byte[i_6_][i_5_][i_4_];
	if (i != 19278)
    ...
    static {
	aClass114_3143 = new ServerPacket(7, 3);
    }
}
