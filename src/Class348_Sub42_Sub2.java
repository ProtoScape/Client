...
final class Class348_Sub42_Sub2 extends SubNode implements Interface9
{
    ...
    private OpenGlToolkit aHa_Sub2_8564;
    int anInt8565;
	...
	AbstractMouseEvent.method3309(-124);
	...
	Class24.aClass318_Sub1_Sub3Array357 = new Entity[5000];
	Class86.anInt1477 = 0;
    ...
    Class348_Sub42_Sub2(OpenGlToolkit var_ha_Sub2, int i, int i_11_, int i_12_) {
	try {
    ...
    Class348_Sub42_Sub2(OpenGlToolkit var_ha_Sub2, int i, int i_13_, int i_14_,
			int i_15_) {
	try {
