	...
	try {
		...
		if ((IntegerVarScriptSettingLoader.anInt3306 ^ 0xffffffff) != -3
			...
			Class348_Sub22 class348_sub22
				...
				((long) EntityPacket.anIntArray1233[i_22_])));
			...
			if (class318_sub1_sub3_sub3_sub2 != null
				...
				if ((((Player)
				      class318_sub1_sub3_sub3_sub2)
					 .aString10544.equals
				     (Class83.friendListUsernames[i_29_]))
			    ...
			    for (int i_31_ = 0; Class37.amountClanChatUsers > i_31_;
				 i_31_++) {
				if (((Player)
				     class318_sub1_sub3_sub3_sub2)
					.aString10544.equals
				    (((ClanChatPlayer) (Class169.aClass19Array2261
						 [i_31_])).aString306)) {
				    bool_30_ = true;
				    break;
				}
