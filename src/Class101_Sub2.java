...
final class Class101_Sub2 extends Class101
{
    ...
    static GamePacket aClass351_5699;
    float aFloat5700;
    ...
    static ServerPacket aClass114_5742;
	...
	if (i == 99) {
	    ...
	    if (bool) {
		for (Class348_Sub9 class348_sub9
			 = (Class348_Sub9) Client.aClass262_5185.getFirst(4);
		     class348_sub9 != null;
		     class348_sub9
			 = ((Class348_Sub9)
			    Client.aClass262_5185.nextForward((byte) 69))) {
    ...
    static {
	aClass351_5699 = new GamePacket(53, -1);
	aClass114_5742 = new ServerPacket(119, 6);
    }
}
