...
final class Class154
{
	...
	try {
		...
		return (class278.getNpcDefinition
			    (((Class154) this).anInt2093).method800
		...
		if (class64 != null)
		    i_9_ = var_ha.bitOR(i_9_, class64.ua());
		int i_36_ = i_9_;
	...
	try {
		...
		return (class278.getNpcDefinition
			    (((Class154) this).anInt2093).method803
	    ...
	    if (class64 == null || (var_ha.method3667(class64.ua(), i_70_)
				    ^ 0xffffffff) != -1) {
		if (class64 != null)
		    i_70_ = var_ha.bitOR(i_70_, class64.ua());
		int i_80_ = i_70_;
		boolean bool = false;
	...
	try {
		...
		if (class64 != null)
		    i_98_ = var_ha.bitOR(i_98_, class64.ua());
		int i_108_ = i_98_;
	...
	try {
	    anInt2098++;
	    int i_114_ = WorldInfo.anIntArray3661[i_113_];
