...
final class Class348_Sub42_Sub3 extends SubNode
{
    ...
    static ServerPacket aClass114_9503;
	...
	if (i_4_ < 0)
	    ...
	    i_4_ = 100;
	int i_5_ = ((-AbstractWorld.aShort1700 + Class168.aShort2250) * i_4_ / 100
		    + AbstractWorld.aShort1700);
	...
	aClass114_9503 = new ServerPacket(9, -1);
    }
}
