    ...
    implements MouseListener, MouseMotionListener, MouseWheelListener
{
    ...
    private final void addEvent(int i, int i_1_, int i_2_, int i_3_,
				  boolean bool) {
	MouseEvent$ class348_sub45_sub1 = new MouseEvent$();
	((MouseEvent$) class348_sub45_sub1).anInt9725 = i_3_;
	((MouseEvent$) class348_sub45_sub1).anInt9728 = i_1_;
	((MouseEvent$) class348_sub45_sub1).anInt9729 = i;
	((MouseEvent$) class348_sub45_sub1).aLong9726
	    = Class62.getCurrentTimeMillis();
	((MouseEvent$) class348_sub45_sub1).anInt9727 = i_2_;
	if (bool)
	    mouseDragged(null);
    ...
    final AbstractMouseEvent getFirstEvent(int i) {
	if (i != 0)
	    mouseReleased(null);
	return (AbstractMouseEvent) aClass262_7418.removeFirst(8);
    }
