...
final class Class318_Sub1_Sub3_Sub4 extends Entity
{
	...
	if ((i_7_ ^ 0xffffffff) == -1) {
	    Class57[] class57s = ClanChatPlayer.method286((byte) -49, class297);
	    if (class57s == null)
		return null;
	    boolean bool = false;
	    for (int i_10_ = 0;
	...
	do {
		...
		if ((Node.anInt4290 ^ 0xffffffff) > -101) {
		    ...
		    ClientApplet.p12fullFontRasterizer.drawString0("Fps:" + (Class239_Sub5
								  .anInt5891),
		    ...
		    if (i_24_ > 65536)
			i_25_ = 16711680;
		    ClientApplet.p12fullFontRasterizer.drawString0("Mem:" + i_24_ + "k",
							i_23_, i_25_, i_22_,
							-127, -1);
		    i_23_ -= 15;
		}
