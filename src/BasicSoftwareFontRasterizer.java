...
final class BasicSoftwareFontRasterizer extends AbstractFontRasterizer
{
    ...
    BasicSoftwareFontRasterizer(SoftwareToolkit var_ha_Sub1, BitmapFont class143, ImageSprite[] class207s,
		  int[] is, int[] is_49_) {
	...
	for (int i = 0; i < class207s.length; i++) {
	    aByteArrayArray6502[i] = ((ImageSprite) class207s[i]).colorIndex;
	    anIntArray6501[i] = ((ImageSprite) class207s[i]).heightOffset;
	    anIntArray6498[i] = ((ImageSprite) class207s[i]).widthOffset;
	}
	anIntArray6496 = ((ImageSprite) class207s[0]).colors;
    }
