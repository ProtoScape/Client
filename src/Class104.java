...
final class Class104
{
    ...
    private OpenGlToolkit aHa_Sub2_1616;
    byte[] aByteArray1617;
	...
	float f = 1.0F / (float) (((OpenGlToolkit) aHa_Sub2_1616).anInt7733 * 128);
	if (!bool) {
		...
		for (int i_42_ = 0;
			...
			= ((OpenGlToolkit) aHa_Sub2_1616).aClass348_Sub49_Sub1_7798;
			...
			if ((-i_36_ + i_46_ ^ 0xffffffff) <= (-i_35_
				...
				if (((-i_37_ + i_48_ ^ 0xffffffff)
				    ...
				    if (is != null) {
					if (!((OpenGlToolkit) aHa_Sub2_1616)
					     .aBoolean7775) {
					    for (int i_49_ = 0;
