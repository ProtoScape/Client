...
final class VarpHandler implements ConfigHandler
{
	...
	for (int i_21_ = 0; ((Class348_Sub1.anIntArray6547.length ^ 0xffffffff)
		...
		= var_ha.createFontRasterizer(class143,
				    ImageSprite.getSprites(Class39.spriteIndexLoader,
							i_22_),
				    true);
	...
	for (int i_38_ = 0; i_38_ < Class101.anInt1597; i_38_++) {
		...
		npc.method2448((Class189.npcLoader.getNpcDefinition(Class299.gameBuffer.method3355(-1))), -2);
		npc.method2434
		...
		for (int i_51_ = 0;
		    ...
		    is_49_[i_51_] = Class299.gameBuffer
					.method3329((byte) 21);
		    is_50_[i_51_]
			= Class299.gameBuffer.getWordLE128(-109);
		}
