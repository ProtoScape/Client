...
{
    Buffer aBuffer1792;
    private OpenGlToolkit aHa_Sub2_1793;
	...
	if (((Class119) this).aBuffer1792 == null
		...
		= ((OpenGlToolkit) aHa_Sub2_1793).aNativeHeap7730.a(i, false);
	((Class119) this).aBuffer1792.a(is, 0, 0, i);
    }
    
    Class119(OpenGlToolkit var_ha_Sub2, byte[] is, int i) {
    ...
    Class119(OpenGlToolkit var_ha_Sub2, Buffer buffer) {
	aHa_Sub2_1793 = var_ha_Sub2;
