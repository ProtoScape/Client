...
final class Class43
{
    ...
    static int anInt616;
    int[] anIntArray617;
    static GamePacket aClass351_618 = new GamePacket(5, 3);
	...
	if (i != 68)
	    method381((byte) -42);
	return ServerPacket.method1059((byte) 95, 1);
    }
    
    static final void setClientSettings(String string, boolean bool) {
	anInt613++;
	Class239_Sub12.clientSettings = string;
	if (bool != true)
	    method381((byte) -48);
