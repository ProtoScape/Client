...
final class Class153
{
	...
	byte[] is = (Class113.indexLoader12.getArchive
	...
	if (class348_sub42_sub19 != null)
	    return class348_sub42_sub19;
	is = (Class113.indexLoader12.getArchive
	      (Class113.indexLoader12.getNameHashIndex(i_7_)));
	if (is != null) {
	    if ((is.length ^ 0xffffffff) >= -2)
		return null;
	...
	synchronized (aClass45_2084) {
	    is = aClass45_2084.getChildArchive(36, i);
	}
	class42 = new Class42();
	...
	try {
	    ...
	    aClass45_2084.getAmountChildEntries(36);
