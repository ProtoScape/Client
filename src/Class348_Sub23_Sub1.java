...
final class Class348_Sub23_Sub1 extends Class348_Sub23
{
	...
	return new Class50_Sub3(class348_sub49.getWord(13638),
				class348_sub49.getWord(i + 13636),
				class348_sub49.getWord(13638),
				class348_sub49.getWord(i ^ 0x3544),
				class348_sub49.getWord(13638),
				class348_sub49.getWord(i + 13636),
				class348_sub49.getWord(13638),
				class348_sub49.getWord(13638),
	...
	if (((Signlink) signlink).allowsFileOperations) {
		...
		Class251.anInt3234
		    = (((AbstractWorld) Class65.lobbyWorlds[i])
		       .settingFlags);
	    return true;
	}
	String string_4_ = "";
	...
	if (Class239_Sub12.clientSettings != null)
	    string_5_ = "/p=" + Class239_Sub12.clientSettings;
	String string_6_
	    = ("http://" + string + string_4_ + "/l="
	       + Class348_Sub33.gameLanguage + "/a=" + SocketWorker.affiliateId
