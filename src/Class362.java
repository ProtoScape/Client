	...
	try {
		...
		if (Class295.aBoolean3763 && bool_0_) {
		    ...
		    int i_6_ = (Class239_Sub27.aClass341_6128
				    .method2679(OpenGlToolkit.anInt7666, i_2_, 1595)
				+ Class239_Sub3.anInt5871);
		    if (Class59_Sub1.aBoolean5300) {
			i_5_ += s_Sub3.method4008((byte) -124);
			i_6_ += Class16.method260(false);
		    }
		    var_ha.createRasterForSprite(FileIndexWorker.aClass207_1727, false).method965
			((((ImageSprite) Class348_Sub40_Sub1.aClass207_9090)
			  .indexWidth) + i_5_,
			 (((ImageSprite) Class348_Sub40_Sub1.aClass207_9090)
			  .indexHeight) + i_6_,
			 -(2 * (((ImageSprite) Class348_Sub40_Sub1.aClass207_9090)
				.indexWidth)) + i_1_,
			 -((((ImageSprite) Class348_Sub40_Sub1.aClass207_9090)
			    .indexHeight)
			   * 2) + i_2_,
		    ...
		    Class348_Sub40_Sub1.aClass207_9090.reflectX();
		    var_ha.createRasterForSprite(Class348_Sub7.aClass207_6643, true)
			.method972
			(i_5_,
			 (((ImageSprite) Class348_Sub40_Sub1.aClass207_9090)
			  .indexHeight) + i_6_,
