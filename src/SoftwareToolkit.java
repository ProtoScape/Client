...
final class SoftwareToolkit extends AbstractToolkit
{
	...
	if (i_94_ == -1)
	    ...
	    i_93_++;
	    ((AbstractSoftwareRaster) aClass105_7513).method996
	...
	return new SoftwareRaster(this, is, width, height);
    }
	...
	if (class348_sub31 == null) {
	    class348_sub31 = AbstractWorld.method1035(9029, i_232_, canvas, i);
    ...
    final AbstractFontRasterizer createFontRasterizer(BitmapFont class143, ImageSprite[] sprites,
	...
	for (int i = 0; i < sprites.length; i++) {
	    indexWidths[i] = ((ImageSprite) sprites[i]).indexWidth;
	    indexHeights[i] = ((ImageSprite) sprites[i]).indexHeight;
	    if (((ImageSprite) sprites[i]).alphaIndex != null)
		isAlphaIndexed = true;
	}
	if (supportsAlpha) {
	    if (isAlphaIndexed)
	...
	if (i_379_ != 0 && i_380_ != 0) {
		...
		((AbstractSoftwareRaster) aClass105_7513).method996(i - i_379_,
							   i_377_ - i_380_,
							   i_378_, i_379_ << 1,
							   i_380_ << 1, i_384_,
							   i_383_, i_385_, 1);
	...
	if (bool_425_)
	    return new BufferedSoftwareRaster(this, is, i, i_422_, i_423_, i_424_,
					  bool);
	return new SoftwareRaster(this, is, i, i_422_, i_423_, i_424_,
				      bool);
    }
    
    final RasterToolkit createRasterForSprite(ImageSprite sprite, boolean bool) {
	int[] is = ((ImageSprite) sprite).colors;
	byte[] is_430_ = ((ImageSprite) sprite).colorIndex;
	int i = ((ImageSprite) sprite).indexWidth;
	int i_431_ = ((ImageSprite) sprite).indexHeight;
	AbstractSoftwareRaster class105_sub3;
	if (bool && ((ImageSprite) sprite).alphaIndex == null) {
	    ...
	    byte[] is_439_ = ((ImageSprite) sprite).alphaIndex;
	    if (is_439_ != null) {
		...
		class105_sub3 = new BufferedSoftwareRaster(this, is_438_, i, i_431_);
	    } else {
		...
		class105_sub3
		    = new SoftwareRaster(this, is_438_, i, i_431_);
	    }
	}
	class105_sub3.method985(((ImageSprite) sprite).widthOffset,
				((ImageSprite) sprite).heightOffset,
				((ImageSprite) sprite).widthPadding,
				((ImageSprite) sprite).heightPadding);
	...
	return new SoftwareRaster(this, i, i_519_);
    }
	...
	if (class348_sub31 != null) {
	    ...
	    class348_sub31 = AbstractWorld.method1035(9029, i_578_, canvas, i);
	    fetcherTable.putNode((long) canvas.hashCode(),
				      class348_sub31);
    ...
    final int bitOR(int i, int i_640_) {
	return i | i_640_;
    }
