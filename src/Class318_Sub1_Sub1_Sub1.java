    ...
    implements Interface10
{
	...
	if (i != -12031)
	    writeJoinClanchatPacket(null, -125);
	anInt9954++;
    }
	...
	int i_2_ = ((Class318_Sub1) this).xHash >> 385218761;
    ...
    static final void writeJoinClanchatPacket(String string, int i) {
	int i_15_ = 87 / ((i - -7) / 56);
	anInt9958++;
	if (!string.equals("")) {
	    Class88.anInt1498++;
	    BufferedPacket class348_sub47 = Class286_Sub3.createBufferedPacket(Class318_Sub1_Sub1.gamePacket50, Class348_Sub23_Sub2.outgoingGameIsaac);
	    ((BufferedPacket) class348_sub47).buffer.putByte(Class239_Sub6.getStringLength(string, -65));
	    ((BufferedPacket) class348_sub47).buffer.putJStr((byte) -5, string);
	    Class348_Sub42_Sub14.queuePacket(121, class348_sub47);
	}
    }
