...
final class ScriptExecutor
{
	...
	if (class348_sub42_sub19 != null) {
		...
		|| (((ClientScript) class348_sub42_sub19)
		    .aClass273_9691) == IsaacCipher.aClass273_1298) {
		int i_1_ = 0;
		int i_2_ = 0;
	...
	if (i < 5100) {
		...
		Class348_Sub42_Sub14.queuePacket(-77, class348_sub47);
		return;
	    }
	    if (i == 5002) {
		anInt1170 -= 2;
		...
		Class348_Sub42_Sub14.queuePacket(-85, class348_sub47);
		return;
	    }
	    if (i == 5003) {
		...
		((BufferedPacket) class348_sub47).buffer
		    .putByte(i_14_);
		Class348_Sub42_Sub14.queuePacket(-70, class348_sub47);
		return;
	    }
	    if (i == 5008) {
		String string = strStack[--anInt1170];
		...
		((BufferedPacket) class348_sub47).buffer
		    ...
		    (115, (((ByteBuffer) (((BufferedPacket) class348_sub47)
					      .buffer))
			   .position) - i_41_);
		Class348_Sub42_Sub14.queuePacket(127, class348_sub47);
		return;
	    }
	    if (i == 5060) {
		String string = strStack[--anInt1170];
		...
		((BufferedPacket) class348_sub47).buffer
		    ...
		    (92, (((ByteBuffer) (((BufferedPacket) class348_sub47)
					     .buffer))
			  .position) - i_43_);
		Class348_Sub42_Sub14.queuePacket(-111, class348_sub47);
		return;
	    }
	    if (i == 5062) {
		intStackOffset -= 2;
		...
		((BufferedPacket) class348_sub47).buffer
		    .putByte(i_107_);
		Class348_Sub42_Sub14.queuePacket(-66, class348_sub47);
		return;
	    }
	    if (i == 5401) {
		intStackOffset -= 2;
		...
		if (string.length() <= 320 && Class240.anInt4674 == 3 && (Class225.anInt2955 == 0 && Class367_Sub2.anInt7297 == 0)) {
		    ...
		    Class186.playerUsername = string_142_;
		...
		if (string.length() <= 320 && Class240.anInt4674 == 3
		    ...
		    Class64_Sub3.playerPassword = string;
		    Class186.playerUsername = string_145_;
		...
		if (i_149_ != i_150_) {
			...
			if (i_150_ == 0 && RequiredElement.anInt3428 != -1) {
			    ...
			    EntityPacket.aBoolean1236 = false;
			} else if (i_149_ == 0) {
	    ...
	    if (i == 6200) {
		intStackOffset -= 2;
		AbstractWorld.aShort1700 = (short) intStack[intStackOffset];
		if (AbstractWorld.aShort1700 <= 0)
		    AbstractWorld.aShort1700 = (short) 256;
	    ...
	    if (i == 6205) {
		intStack[intStackOffset++] = AbstractWorld.aShort1700;
		...
		if (Class240.anInt4674 != 7 || Class225.anInt2955 != 0 || Class367_Sub2.anInt7297 != 0)
		    ...
		    if (Class130.lobbyUpdateSent)
			intStack[intStackOffset++] = 0;
		    else {
			if (Class240.lastUpdatedTime > Class62.getCurrentTimeMillis() - 1000L)
			    intStack[intStackOffset++] = 1;
			else {
			    Class130.lobbyUpdateSent = true;
			    BufferedPacket outgoingBuffer = Class286_Sub3.createBufferedPacket((Class348_Sub23_Sub2.gamePacket30), (Class348_Sub23_Sub2.outgoingGameIsaac));
			    ((BufferedPacket) outgoingBuffer).buffer.putInt(Class5_Sub1.lobbyUnknown);
			    Class348_Sub42_Sub14.queuePacket(118, outgoingBuffer);
			    intStack[intStackOffset++] = 0;
			    return;
			}
			return;
		...
		if (world != null) {
		    intStack[intStackOffset++] = ((LobbyWorld) world).worldId;
		    intStack[intStackOffset++] = ((AbstractWorld) world).settingFlags;
		    strStack[anInt1170++] = ((LobbyWorld) world).activity;
		    WorldInfo class283 = world.getInfo();
		    intStack[intStackOffset++] = ((WorldInfo) class283).country;
		    strStack[anInt1170++] = ((WorldInfo) class283).region;
		    intStack[intStackOffset++] = ((AbstractWorld) world).amountPlayers;
		...
		if (class110_sub1 != null) {
		    intStack[intStackOffset++] = ((LobbyWorld) class110_sub1).worldId;
		    intStack[intStackOffset++] = ((AbstractWorld) class110_sub1).settingFlags;
		    strStack[anInt1170++] = ((LobbyWorld) class110_sub1).activity;
		    WorldInfo location = class110_sub1.getInfo();
		    intStack[intStackOffset++] = ((WorldInfo) location).country;
		    strStack[anInt1170++] = ((WorldInfo) location).region;
		    intStack[intStackOffset++] = ((AbstractWorld) class110_sub1).amountPlayers;
		...
		if (i == 6911) {
		    intStack[intStackOffset++] = ClientApplet.anInt37;
		    return;
		}
		if (i == 6912) {
	...
	if (Class192.playerRights != 0
		...
		(119, (((ByteBuffer) (((BufferedPacket) class348_sub47)
					  .buffer))
		       .position) - i_243_);
	    Class348_Sub42_Sub14.queuePacket(124, class348_sub47);
	}
    }
	...
	if (i < 300) {
		...
		if (i == 1800) {
		    intStack[intStackOffset++]
			= Client.method105(class46).method3307(83);
		    return;
		}
		if (i == 1801) {
		...
		if (i == 2800) {
		    intStack[intStackOffset++]
			= Client.method105(class46).method3307(11);
		    return;
		}
		if (i == 2801) {
		...
		if (i == 3105) {
			...
			.buffer
			.putJStr((byte) -5, string);
		    Class348_Sub42_Sub14.queuePacket(-81, class348_sub47);
		    return;
		}
		if (i == 3106) {
		    String string = strStack[--anInt1170];
			...
			.buffer
			.putJStr((byte) -5, string);
		    Class348_Sub42_Sub14.queuePacket(35, class348_sub47);
		    return;
		}
		if (i == 3107) {
		...
		if (i == 3316) {
		    if (Class192.playerRights >= 2)
			intStack[intStackOffset++] = Class192.playerRights;
		    else {
			intStack[intStackOffset++] = 0;
			return;
		    }
		...
		if (i == 3337) {
		    intStack[intStackOffset++] = SocketWorker.affiliateId;
		    return;
		}
		if (i == 3338) {
		...
		if (i == 3600) {
		    if (Class125.socialListStates == 0)
			intStack[intStackOffset++] = -2;
		    else {
			if (Class125.socialListStates == 1)
			    intStack[intStackOffset++] = -1;
			else {
			    intStack[intStackOffset++]
		...
		if (i == 3601) {
		    ...
		    if (Class125.socialListStates == 2
			&& i_359_ < Class348_Sub40_Sub30.friendListLength) {
			strStack[anInt1170++]
			    = Class83.friendListUsernames[i_359_];
			if (Class286_Sub2.friendListGamenames[i_359_] != null)
			    strStack[anInt1170++]
				= Class286_Sub2.friendListGamenames[i_359_];
			else
			    strStack[anInt1170++] = "";
		    } else {
			strStack[anInt1170++] = "";
		...
		if (i == 3602) {
		    ...
		    if (Class125.socialListStates == 2 && i_360_ < Class348_Sub40_Sub30.friendListLength)
			intStack[intStackOffset++] = AbstractToolkit.anIntArray4578[i_360_];
		    else {
			intStack[intStackOffset++] = 0;
			return;
		    }
		...
		if (i == 3603) {
		    ...
		    if (Class125.socialListStates == 2
			&& i_361_ < Class348_Sub40_Sub30.friendListLength)
			intStack[intStackOffset++]
			    = Class172.clanChatRanking[i_361_];
		    else {
			intStack[intStackOffset++] = 0;
			return;
		    }
		...
		if (i == 3607) {
		    String string = strStack[--anInt1170];
		    Class27.addToIgnoreList(string, false);
		    return;
		}
		if (i == 3608) {
		    String string = strStack[--anInt1170];
		...
		if (i == 3610) {
		    ...
		    if (Class125.socialListStates == 2
			&& i_363_ < Class348_Sub40_Sub30.friendListLength)
			strStack[anInt1170++]
			    = Class285.clanChatWorld[i_363_];
		    else {
			strStack[anInt1170++] = "";
			return;
		    }
		...
		if (i == 3612) {
		    if (Class50.aString863 != null)
			intStack[intStackOffset++] = Class37.amountClanChatUsers;
		    else {
			intStack[intStackOffset++] = 0;
			return;
		    }
		...
		if (i == 3613) {
		    ...
		    if (Class50.aString863 != null
			&& i_364_ < Class37.amountClanChatUsers)
			strStack[anInt1170++]
			    = (((ClanChatPlayer) Class169.aClass19Array2261[i_364_])
			       .aString314);
		    else {
			strStack[anInt1170++] = "";
			return;
		...
		if (i == 3614) {
		    ...
		    if (Class50.aString863 != null
			&& i_365_ < Class37.amountClanChatUsers)
			intStack[intStackOffset++]
			    = (((ClanChatPlayer) Class169.aClass19Array2261[i_365_])
			       .anInt308);
		    else {
			intStack[intStackOffset++] = 0;
			return;
		...
		if (i == 3615) {
		    ...
		    if (Class50.aString863 != null
			&& i_366_ < Class37.amountClanChatUsers)
			intStack[intStackOffset++]
			    = (((ClanChatPlayer) Class169.aClass19Array2261[i_366_])
			       .aByte310);
		    else {
			intStack[intStackOffset++] = 0;
			return;
		...
		if (i == 3619) {
		    String string = strStack[--anInt1170];
		    Class318_Sub1_Sub1_Sub1.writeJoinClanchatPacket(string, -117);
		    return;
		}
		if (i == 3620) {
		...
		if (i == 3622) {
		    ...
		    if (Class125.socialListStates != 0
			&& i_367_ < Class348_Sub42_Sub12.ignoreListLength) {
			strStack[anInt1170++]
			    = ObjectDefinition.ignoreListUsernames[i_367_];
			if (Class348_Sub40_Sub21.ignoreListGamenames[i_367_]
			    != null)
			    strStack[anInt1170++]
				= (Class348_Sub40_Sub21.ignoreListGamenames
				   [i_367_]);
			else
			    strStack[anInt1170++] = "";
		    } else {
		...
		if (i == 3623) {
			...
			string = string.substring(7);
		    intStack[intStackOffset++]
			= GamePacket.method3455(string, 28280) ? 1 : 0;
		    return;
		}
		if (i == 3624) {
		    int i_368_ = intStack[--intStackOffset];
		    if (Class169.aClass19Array2261 != null
			&& i_368_ < Class37.amountClanChatUsers
			&& (((ClanChatPlayer) Class169.aClass19Array2261[i_368_])
		...
		if (i == 3626) {
		    ...
		    if (Class50.aString863 != null
			&& i_369_ < Class37.amountClanChatUsers)
			strStack[anInt1170++]
			    = (((ClanChatPlayer) Class169.aClass19Array2261[i_369_])
			       .aString313);
		    else {
			strStack[anInt1170++] = "";
			return;
		...
		if (i == 3627) {
		    ...
		    if (Class125.socialListStates == 2 && i_370_ >= 0
			&& i_370_ < Class348_Sub40_Sub30.friendListLength)
			intStack[intStackOffset++]
		...
		if (i == 3630) {
		    String string = strStack[--anInt1170];
		    Class27.addToIgnoreList(string, true);
		    return;
		}
		if (i == 3631) {
		...
		if (i == 3632) {
		    ...
		    if (Class50.aString863 != null
			&& i_372_ < Class37.amountClanChatUsers)
			strStack[anInt1170++]
			    = (((ClanChatPlayer) Class169.aClass19Array2261[i_372_])
			       .aString306);
		    else {
			strStack[anInt1170++] = "";
			return;
		...
		if (i == 3633) {
		    ...
		    if (Class125.socialListStates != 0
			&& i_373_ < Class348_Sub42_Sub12.ignoreListLength)
			strStack[anInt1170++]
		...
		if (i == 4109) {
		    String string = strStack[--anInt1170];
		    intStackOffset -= 2;
		    int color = intStack[intStackOffset];
		    int fontId = intStack[intStackOffset + 1];
		    BitmapFont class143
			= Class239_Sub23.method1819(fontId, 0, -79,
						    Class104.indexLoader13);
		    intStack[intStackOffset++]
			= class143.method1187(string, false, color,
	...
	try {
		...
		if (opcode < 100) {
			...
			intStack[intStackOffset++] = IsaacCipher.globalScriptIntVars[intOperands[position]];
		    else if (opcode == 43) {
			int i_502_ = intOperands[position];
			IsaacCipher.globalScriptIntVars[i_502_]
			    = intStack[--intStackOffset];
		...
		ClientApplet.addConsoleMessage(stringbuffer.toString());
	    } else {
		StringBuffer stringbuffer = new StringBuffer(30);
