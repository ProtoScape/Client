...
abstract class NativeToolkit extends AbstractToolkit
{
	...
	try {
	    ...
	    if ((((ImageSprite) class207).indexWidth ^ 0xffffffff) == -1
		|| ((ImageSprite) class207).indexHeight == 0)
		...
		if (((ImageSprite) class207).alphaIndex == null) {
		    for (int i_212_ = 0;
			 ((((ImageSprite) class207).indexHeight ^ 0xffffffff)
			  < (i_212_ ^ 0xffffffff));
			 i_212_++) {
			for (int i_213_ = 0;
			     i_213_ < ((ImageSprite) class207).indexWidth;
			     i_213_++) {
			    int i_214_ = (((ImageSprite) class207).colors
		    ...
		    for (int i_215_ = 0;
			 i_215_ < ((ImageSprite) class207).indexHeight; i_215_++) {
			for (int i_216_ = 0;
		...
		class105 = this.method3662(((ImageSprite) class207).indexWidth, is,
					   (byte) 94, 0,
    ...
    final int bitOR(int i, int i_273_) {
	anInt8030++;
	return i_273_ | i;
    }
