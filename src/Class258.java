...
abstract class Class258 implements Interface9
{
	...
	anInt4852++;
	int i_0_ = 22 / ((i - -31) / 50);
	if (((OpenGlToolkit) ((Class258) this).aHa_Sub2_4851).aBoolean7820) {
	...
	if (i_3_ < 17)
	    aBoolean4856 = true;
	((OpenGlToolkit) ((Class258) this).aHa_Sub2_4851).anInt7748 -= i;
	((OpenGlToolkit) ((Class258) this).aHa_Sub2_4851).anInt7748
	    += method1951(-106);
    }
    ...
    Class258(OpenGlToolkit var_ha_Sub2, int i, int i_5_, int i_6_, boolean bool) {
	aBoolean4860 = bool;
