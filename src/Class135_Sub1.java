...
final class Class135_Sub1 extends Class135 implements Interface2
{
    ...
    Class135_Sub1(OpenGlToolkit var_ha_Sub2, int i, byte[] is, int i_2_,
		  boolean bool) {
    ...
    Class135_Sub1(OpenGlToolkit var_ha_Sub2, int i, Buffer buffer, int i_3_,
		  boolean bool) {
    ...
    static {
	aClass114_4707 = new ServerPacket(39, 8);
	anInt4718 = 0;
    }
}
