...
final class Widget
{
	...
	int totalHeight = (((ImageSprite) class207).heightOffset + (((ImageSprite) class207).indexHeight + ((ImageSprite) class207).heightPadding));
	((Widget) this).anIntArray772 = new int[totalHeight];
	((Widget) this).anIntArray677 = new int[totalHeight];
	for (int y = 0; ((((ImageSprite) class207).indexHeight ^ 0xffffffff) < (y ^ 0xffffffff)); y++) {
	    int i_13_ = 0;
	    for (int x = 0; ((((ImageSprite) class207).indexWidth ^ 0xffffffff)< (x ^ 0xffffffff)); x++) {
		if ((((ImageSprite) class207).colorIndex[((ImageSprite) class207).indexWidth * y + x]) != 0) {
		    i_13_ = x;
		    break;
		}
	    }
	    int i_15_ = totalWidth;
	    for (int x = i_13_; ((((ImageSprite) class207).indexWidth ^ 0xffffffff) < (x ^ 0xffffffff)); x++) {
		if ((((ImageSprite) class207).colorIndex[((ImageSprite) class207).indexWidth * y + x]) == 0) {
		    i_15_ = x;
		    break;
		}
	    }
	    ((Widget) this).anIntArray677[(((ImageSprite) class207).heightOffset + y)] = ((ImageSprite) class207).widthOffset + i_13_;
	    ((Widget) this).anIntArray772[(y + ((ImageSprite) class207).heightOffset)] = i_15_ + -i_13_;
	}
	if (i < 0)
    ...
    final AnimatableToolkit createAnimatableToolkit(Class150 class150, AnimationLoader class87, int i,
	...
	try {
		...
		AnimatableToolkit class64
		    = (class278.getNpcDefinition(((Widget) this).anInt753)
			   .method803
    ...
    final void initialize(ByteBuffer buffer, boolean bool) {
	anInt743++;
	int i = buffer.getUByte();
	if (i == 255)
	    i = -1;
	((Widget) this).type = buffer.getUByte();
	if ((0x80 & ((Widget) this).type) != 0) {
	    ((Widget) this).type &= 0x7f;
	    ((Widget) this).aString721 = buffer.getJstr();
            System.out.println("Odd String: " + aString721);
	}
	((Widget) this).anInt765 = buffer.getShort();
	((Widget) this).anInt788 = buffer.getWord(13638);
	((Widget) this).anInt739 = buffer.getWord(13638);
	((Widget) this).anInt842 = buffer.getShort();
	((Widget) this).anInt728 = buffer.getShort();
	((Widget) this).aByte778 = buffer.getByte();
	((Widget) this).aByte724 = buffer.getByte();
	((Widget) this).aByte817 = buffer.getByte();
	((Widget) this).aByte681 = buffer.getByte();
	((Widget) this).anInt834 = buffer.getShort();
	...
	if ((((Widget) this).type ^ 0xffffffff) == -1) {
	    ((Widget) this).anInt698 = buffer.getShort();
	    ((Widget) this).anInt791 = buffer.getShort();
	    if ((i ^ 0xffffffff) > -1)
		((Widget) this).aBoolean776 = buffer.getUByte() == 1;
	}
	if ((((Widget) this).type ^ 0xffffffff) == -6) {
	    ((Widget) this).id = buffer.getDword();
	    ((Widget) this).anInt828 = buffer.getShort();
	    int i_37_ = buffer.getUByte();
	    ((Widget) this).aBoolean697 = (i_37_ & 0x1) != 0;
	    ((Widget) this).aBoolean745 = (0x2 & i_37_ ^ 0xffffffff) != -1;
	    ((Widget) this).anInt696 = buffer.getUByte();
	    ((Widget) this).anInt672 = buffer.getUByte();
	    ((Widget) this).anInt809 = buffer.getDword();
	    ((Widget) this).aBoolean790
		= (buffer.getUByte() ^ 0xffffffff) == -2;
	    ((Widget) this).aBoolean735
		= (buffer.getUByte() ^ 0xffffffff) == -2;
	    ((Widget) this).textColor = buffer.getDword();
	}
	if (((Widget) this).type == 6) {
	    ((Widget) this).anInt770 = 1;
	    ((Widget) this).anInt753 = buffer.getShort();
	    if ((((Widget) this).anInt753 ^ 0xffffffff) == -65536)
		((Widget) this).anInt753 = -1;
	    int i_38_ = buffer.getUByte();
		...
		((Widget) this).anInt688 = buffer.getWord(13638);
		((Widget) this).anInt799 = buffer.getWord(13638);
		((Widget) this).anInt757
		    = buffer.getShort();
		((Widget) this).anInt675
		    = buffer.getShort();
	    ...
	    ((Widget) this).anInt699 = buffer.getShort();
	...
	if ((((Widget) this).type ^ 0xffffffff) == -5) {
	    ((Widget) this).bitmapFontId = buffer.getShort();
	    if (((Widget) this).bitmapFontId == 65535)
		((Widget) this).bitmapFontId = -1;
	    ((Widget) this).text = buffer.getJstr();
	    ((Widget) this).anInt673 = buffer.getUByte();
	    ((Widget) this).anInt762 = buffer.getUByte();
	    ((Widget) this).anInt700 = buffer.getUByte();
	    ((Widget) this).aBoolean769
		= (buffer.getUByte() ^ 0xffffffff) == -2;
	    ((Widget) this).textColor = buffer.getDword();
	    ((Widget) this).anInt696 = buffer.getUByte();
	    if (i >= 0)
		((Widget) this).anInt773 = buffer.getUByte();
	}
	...
	if ((((Widget) this).type ^ 0xffffffff) == -10) {
	    ((Widget) this).anInt690 = buffer.getUByte();
	    ((Widget) this).textColor = buffer.getDword();
	    ((Widget) this).aBoolean744 = buffer.getUByte() == 1;
	}
	int i_40_ = buffer.getTri();
	int i_41_ = buffer.getUByte();
	...
	if (i_48_ > 1) {
	    int i_51_ = buffer.getUByte();
	    ((Widget) this).anIntArray706[i_51_]
		= buffer.getShort();
	}
	((Widget) this).aString816 = buffer.getJstr();
	if (((Widget) this).aString816.equals(""))
	    ((Widget) this).aString816 = null;
	((Widget) this).anInt729 = buffer.getUByte();
	((Widget) this).anInt703 = buffer.getUByte();
	((Widget) this).anInt797 = buffer.getUByte();
	((Widget) this).aString780 = buffer.getJstr();
	int i_52_ = -1;
	if (Class348_Sub40_Sub5.method3060(i_40_, bool) != 0) {
	    i_52_ = buffer.getShort();
	    ((Widget) this).anInt824 = buffer.getShort();
	    if (i_52_ == 65535)
		i_52_ = -1;
	    if ((((Widget) this).anInt824 ^ 0xffffffff) == -65536)
		((Widget) this).anInt824 = -1;
	    ((Widget) this).anInt695 = buffer.getShort();
	    if ((((Widget) this).anInt695 ^ 0xffffffff) == -65536)
		((Widget) this).anInt695 = -1;
	}
	if (i >= 0) {
	    ((Widget) this).anInt719 = buffer.getShort();
	...
	if (i >= 0) {
	    int i_53_ = buffer.getUByte();
	    for (int i_54_ = 0; (i_54_ ^ 0xffffffff) > (i_53_ ^ 0xffffffff);
		 i_54_++) {
		int i_55_ = buffer.getTri();
		int i_56_ = buffer.getDword();
		aClass356_711.putNode((long) i_55_, new Class348_Sub35(i_56_));
	    }
	    int i_57_ = buffer.getUByte();
	    for (int i_58_ = 0; (i_57_ ^ 0xffffffff) < (i_58_ ^ 0xffffffff);
		 i_58_++) {
		int i_59_ = buffer.getTri();
		String string = buffer.getJStr2(-13487);
		aClass356_711.putNode((long) i_59_,
					 new StringNode(string));
	    }
	}
	((Widget) this).anObjectArray815 = loadScriptParameters(buffer, -1);
	((Widget) this).anObjectArray811 = loadScriptParameters(buffer, -1);
	((Widget) this).anObjectArray683 = loadScriptParameters(buffer, -1);
	((Widget) this).anObjectArray680 = loadScriptParameters(buffer, -1);
	((Widget) this).anObjectArray714 = loadScriptParameters(buffer, -1);
	((Widget) this).configTriggeredScriptParameters = loadScriptParameters(buffer, -1);
	((Widget) this).anObjectArray751 = loadScriptParameters(buffer, -1);
	((Widget) this).anObjectArray671 = loadScriptParameters(buffer, -1);
	((Widget) this).logicCycleScriptParameters = loadScriptParameters(buffer, -1);
	((Widget) this).anObjectArray741 = loadScriptParameters(buffer, -1);
	if (i >= 0)
	    ((Widget) this).scriptParameters = loadScriptParameters(buffer, -1);
	((Widget) this).anObjectArray839 = loadScriptParameters(buffer, -1);
	((Widget) this).anObjectArray763 = loadScriptParameters(buffer, -1);
	((Widget) this).anObjectArray785 = loadScriptParameters(buffer, -1);
	((Widget) this).anObjectArray742 = loadScriptParameters(buffer, -1);
	((Widget) this).anObjectArray805 = loadScriptParameters(buffer, -1);
	((Widget) this).anObjectArray823 = loadScriptParameters(buffer, -1);
	((Widget) this).anObjectArray692 = loadScriptParameters(buffer, -1);
	((Widget) this).anObjectArray803 = loadScriptParameters(buffer, -1);
	((Widget) this).anObjectArray685 = loadScriptParameters(buffer, -1);
	((Widget) this).anObjectArray708 = loadScriptParameters(buffer, -1);
	((Widget) this).configScriptTriggers = method441(!bool, buffer);
	((Widget) this).anIntArray771 = method441(!bool, buffer);
	((Widget) this).anIntArray731 = method441(!bool, buffer);
	((Widget) this).anIntArray818 = method441(false, buffer);
	((Widget) this).anIntArray831 = method441(false, buffer);
    }
    ...
    final RasterToolkit method443(AbstractToolkit toolkit, byte i) {
	anInt819++;
	Class348_Sub42_Sub13.aBoolean9616 = false;
	...
	if (((Widget) this).aBoolean790)
	    imageSprite.reflectX();
	if (((Widget) this).aBoolean735)
	    imageSprite.reflectY();
	if ((((Widget) this).anInt672 ^ 0xffffffff) < -1)
	    imageSprite.unpack(((Widget) this).anInt672);
	else if (((Widget) this).anInt809 != 0)
	    imageSprite.unpack(1);
	if (((Widget) this).anInt672 >= 1)
	    imageSprite.replaceSomething(1);
	if (((Widget) this).anInt672 >= 2)
	    imageSprite.replaceSomething(16777215);
	if ((((Widget) this).anInt809 ^ 0xffffffff) != -1)
	    imageSprite.method1511(~0xffffff | ((Widget) this).anInt809);
	raster = toolkit.createRasterForSprite(imageSprite, true);
	GamePacket.widgetRasters.put(31902, raster, l, (raster.getWidth() * raster.getHeight() * 4));
	return raster;
    }
