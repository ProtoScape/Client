...
final class Class299_Sub1_Sub2 extends Class299_Sub1
{
    ...
    static GamePacket aClass351_8706 = new GamePacket(79, 3);
    private OpenGlToolkit aHa_Sub2_8707;
	...
	try {
	    anInt8703++;
	    boolean bool = true;
	    Class206 class206 = ((OpenGlToolkit) aHa_Sub2_8707).aClass206_7778;
	    ...
	    if (bool && !((OpenGlToolkit) aHa_Sub2_8707).aBoolean7847)
    ...
    Class299_Sub1_Sub2(OpenGlToolkit var_ha_Sub2, int i) {
