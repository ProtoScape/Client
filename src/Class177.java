...
final class Class177 implements Interface1
{
	...
	i_0_ = (i_0_ * ((Class348_Sub51) BitmapTable.aClass348_Sub51_3959)
		...
		>> -2091864696);
	if (i_0_ != 0 && i != -1) {
	    if (!EntityPacket.aBoolean1236 && (RequiredElement.anInt3428 ^ 0xffffffff) != 0
	    ...
	    EntityPacket.aBoolean1236 = true;
	}
    }
    ...
    static final Entity method1353(int i, int i_4_, int i_5_,
					       Class var_class) {
	Class357 class357
	...
	for (Class148 class148 = ((Class357) class357).aClass148_4396;
		...
		&& ((Entity) class318_sub1_sub3).aShort8743 == i_4_
