...
abstract class AbstractMouseEvent extends Node
{
    static int anInt7102 = 1400;
    static Class304 aClass304_7103 = new Class304(3);
    static int anInt7104;
    static ServerPacket aClass114_7105 = new ServerPacket(101, 20);
    static ServerPacket aClass114_7106 = new ServerPacket(36, -2);
