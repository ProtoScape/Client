...
{
    private OpenGlToolkit aHa_Sub2_6509;
    private Class61 aClass61_6510;
    private Class258_Sub3_Sub1 aClass258_Sub3_Sub1_6511;
    private boolean aBoolean6512;
    
    Class324_Sub5(OpenGlToolkit var_ha_Sub2, BitmapFont class143, ImageSprite[] class207s,
		  boolean bool) {
	super(var_ha_Sub2, class143);
	aHa_Sub2_6509 = var_ha_Sub2;
	int i = 0;
	for (int i_0_ = 0; i_0_ < 256; i_0_++) {
	    ImageSprite class207 = class207s[i_0_];
	    if (((ImageSprite) class207).indexHeight > i)
		i = ((ImageSprite) class207).indexHeight;
	    if (((ImageSprite) class207).indexWidth > i)
		i = ((ImageSprite) class207).indexWidth;
	}
	int i_1_ = i * 16;
	if (bool) {
	    byte[] is = new byte[i_1_ * i_1_];
	    for (int i_2_ = 0; i_2_ < 256; i_2_++) {
		ImageSprite class207 = class207s[i_2_];
		int i_3_ = ((ImageSprite) class207).indexHeight;
		int i_4_ = ((ImageSprite) class207).indexWidth;
		int i_5_ = i_2_ % 16 * i;
		int i_6_ = i_2_ / 16 * i;
		int i_7_ = i_6_ * i_1_ + i_5_;
		int i_8_ = 0;
		if (((ImageSprite) class207).alphaIndex == null) {
		    byte[] is_9_ = ((ImageSprite) class207).colorIndex;
		    ...
		    byte[] is_12_ = ((ImageSprite) class207).alphaIndex;
		...
		ImageSprite class207 = class207s[i_15_];
		int[] is_16_ = ((ImageSprite) class207).colors;
		byte[] is_17_ = ((ImageSprite) class207).alphaIndex;
		byte[] is_18_ = ((ImageSprite) class207).colorIndex;
		int i_19_ = ((ImageSprite) class207).indexHeight;
		int i_20_ = ((ImageSprite) class207).indexWidth;
	...
	for (int i_31_ = 0; i_31_ < 256; i_31_++) {
	    ImageSprite class207 = class207s[i_31_];
	    int i_32_ = ((ImageSprite) class207).indexHeight;
	    int i_33_ = ((ImageSprite) class207).indexWidth;
	    int i_34_ = ((ImageSprite) class207).heightOffset;
	    int i_35_ = ((ImageSprite) class207).widthOffset;
