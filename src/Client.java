...
public final class Client extends ClientApplet {
	...
	ClanChatPlayer.method284((byte) 51);
	Class54.method501(1);
	...
	AbstractWorld.method1030(-24);
	WorldInfo.method2113((byte) 74);
	...
	NativeOpenGlToolkit.method3968(15);
	Class349.method3450();
	...
	AbstractMouseEvent.method3314(5);
	...
	if (this.isValidHost()) {
	    ...
	    Class11.modeWhat = (MapLoader.getConnectionWhat(-121, Integer.parseInt(this.getParameter("modewhat"))));
	    ...
	    try {
		SocketWorker.affiliateId
		    = Integer.parseInt(this.getParameter("affid"));
	    } catch (Exception exception) {
		SocketWorker.affiliateId = 0;
	    }
	    Class116.aString1761 = this.getParameter("quiturl");
	    Class239_Sub12.clientSettings = this.getParameter("settings");
	    if (Class239_Sub12.clientSettings == null)
		Class239_Sub12.clientSettings = "";
	    ...
	    this.initializeApplet(Class92.anInt1524, 634, OpenGlToolkit.anInt7666, Class11.modeWhat.method1640(0) + 32, 37,
	...
	for (int i_42_ = 0; i_42_ < class46s.length; i_42_++) {
		...
		if (((Widget) widget).type != 0
			...
			if (((Widget) widget).aBoolean682
				...
				InterfaceScript interfaceScript = new InterfaceScript();
				((InterfaceScript) interfaceScript).parent = widget;
				((InterfaceScript) interfaceScript).parameters = ((Widget) widget).logicCycleScriptParameters;
				OutputstreamWorker.aClass262_2707.addToFront(interfaceScript, -20180);
			    }
	...
	for (int i = 0; i < Class367_Sub4.mapSizeX; i++) {
	    int[] is = Class348_Sub42_Sub17.anIntArrayArray9678[i];
	    for (int i_91_ = 0; i_91_ < Class348_Sub40_Sub3.mapSizeY; i_91_++)
		is[i_91_] = 0;
	}
    }
	...
	for (int i_96_ = 0;
		...
		if ((i_97_ & 0x1) != 0) {
			...
			if ((i_99_ ^ 0xffffffff) != -1
			    ...
			    if (i_101_ < 0)
				i_101_ = 0;
			    else if ((Class367_Sub4.mapSizeX + -i_98_ + -1
				      ^ 0xffffffff)
				     > (i_101_ ^ 0xffffffff))
				i_101_
				...
				i_102_ = 0;
				     ...
				     < ((-i_98_ + Class348_Sub40_Sub3.mapSizeY
					 - 1)
					^ 0xffffffff))
				i_102_ = (-i_98_
					  + Class348_Sub40_Sub3.mapSizeY - 1);
			...
			BufferedPacket class348_sub47
			    = Class286_Sub3.createBufferedPacket((Class239_Sub10
							.aClass351_5938),
						       (Class348_Sub23_Sub2
							.outgoingGameIsaac));
			Class348_Sub42_Sub14.queuePacket(-49, class348_sub47);
		    }
		    try {
	...
	if (Class240.anInt4674 != 14) {
	    ...
	    Class98.anInt1565 = 0;
	    for (AbstractMouseEvent mouseEvent
	...
	for (int i_115_ = 0; i_115_ < Class150.anInt2057; i_115_++) {
	    Npc class318_sub1_sub3_sub3_sub1
		= (((Class348_Sub22) (Class348_Sub22)
		    Class282.aClass356_3654.get((long) (EntityPacket
							       .anIntArray1233
							       [i_115_])))
		   .aClass318_Sub1_Sub3_Sub3_Sub1_6859);
	...
	if (Class240.anInt4674 != 14) {
	    ...
	    if (bool_118_ && EntityPacket.aBoolean1236
		...
		VarpHandler.method1309(bool_120_, 117);
	    else if (!WorldInfo.method2114(Class240.anInt4674, bool)) {
		if (!Class348_Sub42_Sub8.method3197(Class240.anInt4674,
			...
			if ((Class36.anInt489 ^ 0xffffffff) == -2) {
			    if (Class268.failedMapArchives > Class348_Sub46.anInt7115)
				Class348_Sub46.anInt7115 = Class268.failedMapArchives;
			    int i = ((-Class268.failedMapArchives
				      + Class348_Sub46.anInt7115)
				     * 50 / Class348_Sub46.anInt7115);
			    Class362.method3511(true, ClientApplet.p12fullFontRasterizer,
			...
			if (Class240.anInt4674 == 13)
			    Class362.method3511(false,
						ClientApplet.p12fullFontRasterizer,
						Class246.p12fullBitmapFont,
						((GameText.connectionLostGameText
						      .getLanguageText
						  (Class348_Sub33.gameLanguage))
						 + "<br>"
						 + (GameText.restablishGameText
							.getLanguageText
						    (Class348_Sub33.gameLanguage))),
						2, Class348_Sub8.currentToolkit);
		    } else
    ...
    final String getErrorMessage(byte i) {
	anInt5175++;
	String string = null;
	try {
	    string = ("[1)" + za_Sub2.baseRegionX + "," + Class90.baseRegionY + ","
