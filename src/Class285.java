...
abstract class Class285 implements Interface5
{
    ...
    static String[] clanChatWorld = new String[200];
    ...
    NativeOpenGlToolkit aClass377_4759;
	...
	anInt4742++;
	if (i == 0) {
	    if (((NativeOpenGlToolkit) ((Class285) this).aClass377_4759).aBoolean9920)
		OpenGL.glBindBufferARB(anInt4755, anInt4746);
	}
    }
    ...
    Class285(NativeOpenGlToolkit class377, int i, boolean bool) {
