...
final class Class366 implements Interface5_Impl1
{
    ...
    private DirectxToolkit aClass378_8512;
	...
	if (anInt8508 > anInt8514) {
		...
		= (((DirectxToolkit) aClass378_8512).anIDirect3DDevice9810.a
	...
	if (!aBoolean8510
	    && ue.a((((Class366) this).anIDirect3DVertexBuffer8511.Lock
		     (0, anInt8514, !bool ? 0 : 8192,
		      ((DirectxToolkit) aClass378_8512).aGeometryBuffer9811)),
		    false)) {
	    aBoolean8510 = true;
	    return ((DirectxToolkit) aClass378_8512).aGeometryBuffer9811;
	}
	return null;
    }
    ...
    Class366(DirectxToolkit class378, boolean bool) {
