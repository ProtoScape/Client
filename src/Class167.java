...
final class Class167
{
    ...
    static ServerPacket aClass114_2196 = new ServerPacket(111, -1);
    int anInt2197;
    Runnable runnable;
    ...
    static final boolean parseWorldListUpdate(byte i, byte[] is) {
	anInt2199++;
	ByteBuffer class348_sub49 = new ByteBuffer(is);
	int type = class348_sub49.getUByte();
	if (type != 2)
	    return false;
	boolean rebuildList = (class348_sub49.getUByte() ^ 0xffffffff) == -2;
	if (rebuildList)
	    Class59_Sub2_Sub2.rebuildWorldList(class348_sub49);
	Class348_Sub42_Sub6.parseWorldListStats((byte) -67, class348_sub49);
	return true;
    }
