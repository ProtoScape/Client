...
final class GameMode
{
	...
	do {
		...
		if (ByteBuffer.anInt7207 != -1) {
		    ...
		    if (!Class348_Sub16_Sub2.heightLevelChanged) {
			if (ByteBuffer.anInt7207 == 1)
			    Class43.method383(0);
			...
			if ((i_27_ < 0 || (i_28_ ^ 0xffffffff) > -1
				...
				if ((i_51_ ^ 0xffffffff) < -1) {
				    Class21.aHa326.setDimensions(0, i_49_,
						      ...
						      i_51_ + i_49_);
				    Class21.aHa326.ya();
				    Class21.aHa326.drawScreenOverlay(IsaacCipher.anInt1290);
			...
			Class258_Sub1.method1960(i_12_, i_4_, i_6_, i_5_,
						 ...
						 1, false);
			Class271.method2046();
			Class348_Sub16_Sub2.heightLevelChanged = false;
	...
	try {
	    ...
	    if (((Mob) class318_sub1_sub3_sub3).anInt10218
		> 0)
		((Mob) class318_sub1_sub3_sub3)
		    .anInt10218--;
	    for (int i_73_ = 0;
