...
public class dxVertexLayout extends Class130
{
    ...
    dxVertexLayout(DirectxToolkit class378, Class58[] class58s) {
	VertexElementCollection vertexelementcollection
	    = new VertexElementCollection(((DirectxToolkit) class378).aHb9788);
	int i = 0;
	for (int i_0_ = 0;
	...
	((dxVertexLayout) this).anIDirect3DVertexDeclaration5803
	    = ((DirectxToolkit) class378).anIDirect3DDevice9810
