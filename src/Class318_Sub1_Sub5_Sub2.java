    ...
    implements Interface10
{
    ...
    static ServerPacket aClass114_10149 = new ServerPacket(23, 6);
    ...
    static ServerPacket aClass114_10168;
	...
	if (class64 != null) {
	    int i_0_ = ((Class318_Sub1) this).xHash >> -1531002263;
    ...
    static final Class337 method2493(OpenGlToolkit var_ha_Sub2, int i,
				     Class242[] class242s) {
	try {
	    anInt10167++;
	    for (int i_16_ = 0;
    ...
    static {
	aClass114_10168 = new ServerPacket(2, 6);
    }
}
