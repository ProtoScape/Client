	...
	do {
		...
		if (class348_sub42_sub12 != null
			...
			if (Class192.playerRights <= 0
			    ...
			    Class348_Sub42_Sub14.queuePacket(123,
							    class348_sub47);
			...
			Class348_Sub42_Sub14.queuePacket(120, class348_sub47);
			...
			((BufferedPacket) class348_sub47)
			    .buffer
			    .putShort(i_77_);
			Class348_Sub42_Sub14.queuePacket(-60, class348_sub47);
		    }
		    if (i_76_ == 51) {
			Player class318_sub1_sub3_sub3_sub2
			    = (ClassicLoadingScreen.players
			...
			Class348_Sub42_Sub14.queuePacket(-68, class348_sub47);
			...
			if (i_76_ == 1010) {
				...
				.buffer
				.putShort(i_77_);
			    Class348_Sub42_Sub14.queuePacket(125,
							    class348_sub47);
			}
			...
			if ((i_76_ ^ 0xffffffff) == -51) {
				...
				((byte) -29,
				 (Class182.keyboardListener.method2696(82, -121)
				  ? 1 : 0));
			    Class348_Sub42_Sub14.queuePacket(-40,
							    class348_sub47);
			}
				...
				((BufferedPacket) class348_sub47)
				    ...
				    ((byte) -91,
				     (!Class182.keyboardListener.method2696(82,
				      ...
				      ? 0 : 1));
				Class348_Sub42_Sub14
				    .queuePacket(118, class348_sub47);
