...
final class Class178
{
    ...
    static ServerPacket aClass114_2338 = new ServerPacket(92, -1);
    static HandshakePacket lobbyPacket = new HandshakePacket(14, 0);
    static int anInt2340;
    static HandshakePacket js5initialPacket = new HandshakePacket(15, 4);
    static HandshakePacket gamePacket = new HandshakePacket(16, -2);
    ...
    static HandshakePacket lobbyCredentialsPacket = new HandshakePacket(19, -2);
