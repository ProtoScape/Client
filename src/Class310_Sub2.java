...
final class Class310_Sub2 extends Class310 implements Interface18_Impl3
{
    ...
    Class310_Sub2(DirectxToolkit class378, int i, int i_0_, boolean bool, int[] is,
		  int i_1_, int i_2_) {
	super(class378, Class108.aClass304_1662, Class68.aClass68_1183,
	      bool && ((DirectxToolkit) class378).aBoolean9798, i_0_ * i);
	if (!((DirectxToolkit) ((Class310_Sub2) this).aClass378_3893).aBoolean9792) {
    ...
    Class310_Sub2(DirectxToolkit class378, Class304 class304, Class68 class68, int i,
		  int i_6_) {
	...
	anIDirect3DTexture6332
	    = (((DirectxToolkit) ((Class310_Sub2) this).aClass378_3893)
	       ...
	       (i, i_6_, 1, 0,
		DirectxToolkit.method3958(22, ((Class310_Sub2) this).aClass68_3895,
    ...
    Class310_Sub2(DirectxToolkit class378, Class304 class304, int i, int i_16_,
		  boolean bool, byte[] is, int i_17_, int i_18_) {
	super(class378, class304, Class68.aClass68_1183,
	      bool && ((DirectxToolkit) class378).aBoolean9798, i * i_16_);
	if (!((DirectxToolkit) ((Class310_Sub2) this).aClass378_3893).aBoolean9792) {
	    anInt6333 = Class33.method340(i, (byte) 108);
	...
	if (bool)
		...
		= (((DirectxToolkit) ((Class310_Sub2) this).aClass378_3893)
		   ...
		   (anInt6333, anInt6331, 0, 1024,
		    DirectxToolkit.method3958(22, Class68.aClass68_1183,
					((Class310_Sub2) this).aClass304_3896),
		    1));
	else
	    anIDirect3DTexture6332
