...
final class SafeToolkit extends AbstractToolkit implements ModelToolkit
{
	...
	final RasterToolkit createRasterForSprite(ImageSprite class207, boolean bool) {
		j var_j = new j(this, ((ImageSprite) class207).colors,
				((ImageSprite) class207).colorIndex,
				((ImageSprite) class207).alphaIndex, 0,
				((ImageSprite) class207).indexWidth,
				((ImageSprite) class207).indexWidth,
				((ImageSprite) class207).indexHeight);
		var_j.method985(((ImageSprite) class207).widthOffset,
	...
	final int bitOR(int i, int i_121_) {
		return i | i_121_;
	}
