...
final class Class232
{
    ...
    private OpenGlToolkit aHa_Sub2_3000;
    ...
    Class232(OpenGlToolkit var_ha_Sub2, Class104 class104, s_Sub2 var_s_Sub2, int i,
	...
	try {
		...
		if (!((OpenGlToolkit) aHa_Sub2_3000).aBoolean7775) {
		    for (int i_15_ = 0;
	...
	if (((Class232) this).aBoolean3009) {
	    ...
	    byte[] is_23_ = ((OpenGlToolkit) aHa_Sub2_3000).aByteArray7879;
	    if (i > 115) {
		int i_24_ = 0;
		...
		if (aClass258_Sub3_2998 != null && i_24_ == anInt3010)
			...
			aClass258_Sub3_2998.method1970
			    (0, 0, 128, false, 0, 128, 6406, -69,
			     ((OpenGlToolkit) aHa_Sub2_3000).aByteArray7879, 0);
		    else {
			aClass258_Sub3_2998
			    = new Class258_Sub3(aHa_Sub2_3000, 3553, 6406, 128,
						128, false,
						(((OpenGlToolkit) aHa_Sub2_3000)
						 .aByteArray7879),
						6406, false);
