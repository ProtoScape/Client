...
{
    private OpenGlToolkit aHa_Sub2_2511;
    static GamePacket aClass351_2512;
	...
	if (((OpenGlToolkit) aHa_Sub2_2511).aBoolean7820
	    && ((OpenGlToolkit) aHa_Sub2_2511).aBoolean7783
	    && aClass337_2513 == null) {
	    Class242 class242
	...
	byte[] is = class45.getArchive(i_7_);
	if (is == null)
	    return null;
	return new Class348_Sub17(is);
    }
    
    Class188(OpenGlToolkit var_ha_Sub2) {
	aHa_Sub2_2511 = var_ha_Sub2;
    }
    
    static {
	aClass351_2512 = new GamePacket(16, 7);
    }
}
