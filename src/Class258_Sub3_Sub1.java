...
final class Class258_Sub3_Sub1 extends Class258_Sub3
{
    ...
    Class258_Sub3_Sub1(OpenGlToolkit var_ha_Sub2, int i, int i_0_, int i_1_,
		       int i_2_) {
    ...
    Class258_Sub3_Sub1(OpenGlToolkit var_ha_Sub2, int i, int i_3_, int i_4_,
		       int i_5_, int i_6_) {
    ...
    Class258_Sub3_Sub1(OpenGlToolkit var_ha_Sub2, int i, int i_7_, int i_8_,
    ...
    Class258_Sub3_Sub1(OpenGlToolkit var_ha_Sub2, int i, int i_12_, int i_13_,
    ...
    Class258_Sub3_Sub1(OpenGlToolkit var_ha_Sub2, int i, int i_17_, int i_18_,
    ...
    Class258_Sub3_Sub1(OpenGlToolkit var_ha_Sub2, int i, int i_22_, int i_23_,
    ...
    Class258_Sub3_Sub1(OpenGlToolkit var_ha_Sub2, int i, int i_26_, int i_27_,
		       int i_28_, int[] is) {
    ...
    Class258_Sub3_Sub1(OpenGlToolkit var_ha_Sub2, int i, int i_29_, int i_30_,
