...
final class Class233
{
    ...
    private final void method1649(OpenGlToolkit var_ha_Sub2, int i, int i_0_) {
	anInt3019++;
	Class86.aFloat1478 = ((OpenGlToolkit) var_ha_Sub2).aFloat7768;
	if (i_0_ != 24484)
    ...
    private final void method1650(OpenGlToolkit var_ha_Sub2, byte i) {
	...
	if (Class86.aFloat1478 != ((OpenGlToolkit) var_ha_Sub2).aFloat7768)
	    var_ha_Sub2.xa(Class86.aFloat1478);
    }
    
    final void method1651(OpenGlToolkit var_ha_Sub2, byte i, int i_1_,
			  Class98 class98) {
	try {
	    anInt3017++;
	    if (((OpenGlToolkit) var_ha_Sub2).aClass101_Sub3_7760 != null) {
		if (i_1_ >= 0)
		    method1649(var_ha_Sub2, i_1_, 24484);
		else
		    method1652(false, var_ha_Sub2);
		float f = (((Class101_Sub3)
			    ((OpenGlToolkit) var_ha_Sub2).aClass101_Sub3_7760)
			   .aFloat5756);
		...
		try {
			...
			if (!bool || (Class86.aFloat1478
				      == ((OpenGlToolkit) var_ha_Sub2).aFloat7768)) {
			    if (((OpenGlToolkit) var_ha_Sub2).aFloat7768 != 1.0F)
				var_ha_Sub2.xa(1.0F);
			} else
			    var_ha_Sub2.xa(Class86.aFloat1478);
    ...
    private final void method1652(boolean bool, OpenGlToolkit var_ha_Sub2) {
	Class86.aFloat1478 = ((OpenGlToolkit) var_ha_Sub2).aFloat7768;
	anInt3021++;
    ...
    final void method1654(int i, OpenGlToolkit var_ha_Sub2) {
	if (i == 643267468) {
	    anInt3023++;
	    anInterface2_3027
    ...
    private final void method1655(OpenGlToolkit var_ha_Sub2, int i, int i_18_) {
	anInt3018++;
	if (i_18_ == 785980556) {
	    ...
	    if (!((OpenGlToolkit) var_ha_Sub2).aBoolean7775) {
