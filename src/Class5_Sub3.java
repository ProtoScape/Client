		...
		if (i_5_ == -7257) {
			...
			if (class318_sub1_sub3_sub3_sub2 != null
				...
				Class348_Sub42_Sub14
				    .queuePacket(i_5_ ^ 0x1c2a, class348_sub47);
				...
				Class348_Sub42_Sub14
				    .queuePacket(126, class348_sub47);
				...
				((BufferedPacket) class348_sub47)
				    ...
				    .putByte(0);
				Class348_Sub42_Sub14
				    .queuePacket(-112, class348_sub47);
			    } else if (i != 6) {
				if (i == 7) {
				    ...
				    Class348_Sub42_Sub14
					.queuePacket(127, class348_sub47);
				}
			    } else {
				Huffman.anInt3768++;
				BufferedPacket class348_sub47
				...
				Class348_Sub42_Sub14
				    .queuePacket(i_5_ + 7281, class348_sub47);
			    }
			    break;
			}
		    }
