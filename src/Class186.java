...
abstract class Class186
{
	...
	for (int i_2_ = i;
	    ...
	    long l = (long) EntityPacket.anIntArray1233[i_2_];
    ...
    static {
	aClass74_2491 = new EntityPacket(13, -1);
	aStringArray2494 = new String[100];
	aClass351_2495 = new GamePacket(35, 5);
	playerUsername = "";
