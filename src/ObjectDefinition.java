...
final class ObjectDefinition
{
    ...
    int anInt930;
    boolean aBoolean931;
    static String[] ignoreListUsernames = new String[100];
	...
	try {
		...
		if (class64 != null)
		    i_11_ = var_ha.bitOR(i_11_, class64.ua());
		int i_12_ = i_11_;
		if (i == 10 && i_9_ > 3)
		    i_12_ |= 0x5;
	...
	if ((i_23_ ^ 0xffffffff) < -1) {
		...
		if (class64 != null)
		    i_25_ = var_ha.bitOR(i_25_, class64.ua());
		Model class124 = null;
									...
									if ((i
										...
										if (i == 81) {
											...
											if ((i ^ 0xffffffff) == -92)
												...
												aByte886 = (byte) 5;
												anInt915 = class348_sub49.getWord(13638);
											    } else if (i != 97) {
												if ((i ^ 0xffffffff) != -99) {
												    if ((i ^ 0xffffffff) != -100) {
													if (i != 100) {
																...
																if ((i ^ 0xffffffff) != -161) {
																	...
																	if ((i ^ 0xffffffff) != -166) {
																		...
																		if (i == 167)
																			...
																			if (i != 170) {
																			    if ((i ^ 0xffffffff) == -172)
																				((ObjectDefinition) this).anInt953 = class348_sub49.getSmartB();
																			    else if (i == 173) {
																			    ...
																			    ((ObjectDefinition) this).anInt909 = class348_sub49.getSmartB();
																		    } else
																			((ObjectDefinition) this).aBoolean903 = true;
																		} else
																		    ((ObjectDefinition) this).aBoolean888 = true;
																	    } else
																		anInt890 = class348_sub49.getWord(13638);
																	} else
																	    anInt954 = class348_sub49.getWord(13638);
																    } else
																	anInt893 = class348_sub49.getWord(13638);
																} else {
	...
	try {
		...
		if (class64 != null)
		    i_67_ = var_ha.bitOR(i_67_, class64.ua());
