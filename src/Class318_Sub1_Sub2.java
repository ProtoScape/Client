...
abstract class Class318_Sub1_Sub2 extends Class318_Sub1
{
	...
	try {
	    ...
	    int i_0_ = -4 % ((-12 - i) / 38);
	    for (int varId = 0; ((IsaacCipher.globalScriptIntVars.length ^ 0xffffffff)
				< (varId ^ 0xffffffff)); varId++) {
		if (Class286_Sub6.isCsVariableActive[varId]) {
		    class348_sub49.putShort(varId);
		    class348_sub49.putInt(IsaacCipher.globalScriptIntVars[varId]);
		}
	    }
	...
	if (class148 == null
	    ...
	    return aa_Sub2.method164(((Class318_Sub1) this).heightLevel,
				     (((Class318_Sub1) this).xHash
				      >> Class362.anInt4459),
				     (byte) -97,
				     (((Class318_Sub1) this).anInt6388
	...
	return (Class125.method1110
		(((Class318_Sub1) this).anInt6388 >> Class362.anInt4459,
		 ...
		 ((Class318_Sub1) this).heightLevel, (byte) -79,
	...
	((Class318_Sub1) this).heightLevel = (byte) i_8_;
	((Class318_Sub1) this).anInt6382 = i_6_;
	((Class318_Sub1) this).mapHeightLevel = (byte) i_9_;
