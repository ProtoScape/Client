...
class ByteBuffer extends Node
{
	...
	final int method3334(int i) {
		...
		int i_6_ = 0;
		int i_7_;
		for (i_7_ = getSmartB(); i_7_ == 32767; i_7_ = getSmartB())
			i_6_ += 32767;
		i_6_ += i_7_;
		return i_6_;
	}
		...
		if (state != Class240.anInt4674) {
			if ((state ^ 0xffffffff) == -14) {
				if (Class348_Sub23_Sub3.sskeyStr != null)
					...
					Class253.method1922(Class186.playerUsername,
							RuntimeException_Sub1.anInt4596,
							Class64_Sub3.playerPassword, true);
			}
			...
			if (state == 5) {
				if (Class348_Sub23_Sub3.sskeyStr == null)
					Class151.method1213(Class64_Sub3.playerPassword,
							Class186.playerUsername, -124);
				else
				...
				if (state == 9) {
					...
					if (Class348_Sub23_Sub3.sskeyStr == null)
						Class151.method1213(Class64_Sub3.playerPassword,
								Class186.playerUsername, -98);
					else
						Class182.method1372(-1);
				}
			} else if (Class348_Sub23_Sub3.sskeyStr == null)
				Class253.method1922(Class186.playerUsername, RuntimeException_Sub1.anInt4596, Class64_Sub3.playerPassword, true);
			else
				Class135_Sub2.method1157(RuntimeException_Sub1.anInt4596,
						(byte) -99);
	...
	final void putBytes(int len, int off, byte[] is) {
		for (int i_75_ = off; off + len > i_75_; i_75_++)
			((ByteBuffer) this).payload
			[((ByteBuffer) this).position++]
			 = is[i_75_];
		anInt7199++;
	...
	final void finalizeVarShort(int i, int i_79_) {
		anInt7157++;
		((ByteBuffer) this).payload
	...
	final void applyRSA(BigInteger exponent, BigInteger modulus) {
		try {
                    anInt7147++;
                    int currentPosition = ((ByteBuffer) this).position;
                    ((ByteBuffer) this).position = 0;
                    byte[] is = new byte[currentPosition];
                    getBytes(is, 0, currentPosition);
                    ...
                    putBytes(is_89_.length, 0, is_89_);
		} catch (RuntimeException runtimeexception) {
			throw Class348_Sub17.method2929(runtimeexception, 
