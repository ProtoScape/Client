...
final class Class348_Sub40_Sub30 extends Class348_Sub40
{
	...
	do {
		...
		anInt9391++;
		if (string != null) {
		    if (friendListLength >= 200 && !Class206.aBoolean4888
			|| (friendListLength ^ 0xffffffff) <= -201) {
			Class59.method544((GameText.fullFriendsListGameText.getLanguageText
			...
			String string_1_ = Class285_Sub1.unformatUsername(string);
			if (string_1_ != null) {
			    for (int i_2_ = 0;
				 ((i_2_ ^ 0xffffffff)
				  > (friendListLength ^ 0xffffffff));
				 i_2_++) {
				String string_3_
				    = (Class285_Sub1.unformatUsername
				...
				if (Class286_Sub2.friendListGamenames[i_2_]
				    != null) {
				    String string_4_
					= (Class285_Sub1.unformatUsername
					   ((Class286_Sub2.friendListGamenames
						[i_2_])));
				    if (string_4_ != null
			    ...
			    for (int i_5_ = 0;
				 i_5_ < Class348_Sub42_Sub12.ignoreListLength;
				 i_5_++) {
				String string_6_
				    = (Class285_Sub1.unformatUsername
				       (ObjectDefinition.ignoreListUsernames[i_5_]));
				if (string_6_ != null
				...
				if (Class348_Sub40_Sub21.ignoreListGamenames[i_5_]
				    != null) {
				    String string_7_
					= (Class285_Sub1.unformatUsername
					   ((Class348_Sub40_Sub21
						.ignoreListGamenames[i_5_])));
				    if (string_7_ != null
			    ...
			    if (Class285_Sub1.unformatUsername
				    ((((Player)
				       (Class132
					.localPlayer))
				      .aString10544))
				...
				Class348_Sub42_Sub14
				    .queuePacket(123, class348_sub47);
				if (i <= -31)
				    break;
				method3127(-4);
			    }
