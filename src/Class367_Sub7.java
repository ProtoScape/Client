...
final class Class367_Sub7 extends Class367
{
    ...
    private DirectxToolkit aClass378_7346;
	...
	if (aBoolean7344) {
		...
		= ((DirectxToolkit) aClass378_7346).anIDirect3DDevice9810;
	    int i_2_ = 1 << (i_0_ & 0x3);
	...
	if (null == class45
	    ...
	    || ((((DirectxToolkit) aClass378_7346).aD3DCAPS9791.VertexShaderVersion
		 & 0xffff)
		^ 0xffffffff) > -258) {
	    anIDirect3DVertexShader7345 = null;
	    aBoolean7347 = false;
