...
final class ColorNode implements Interface12
{
    ...
    static GamePacket aClass351_4905;
    static int[] anIntArray4906;
    static GamePacket aClass351_4907;
	...
	if (Class328_Sub2.loadingStages == null) {
	    ...
	    WorldInfo.loadingStartTime = Class62.getCurrentTimeMillis();
	}
	anInt4900++;
	...
	if (bool == true) {
		...
		ObjectDefinition.loadingHandler.setLoadingStage((WidgetVariable.currentLoadingStage), Class64_Sub2.percentLoadedStr,
						 Class251.anInt3236,
						 WorldInfo.loadingStartTime, false);
	...
	aClass351_4905 = new GamePacket(44, 3);
	aClass351_4907 = new GamePacket(48, 11);
    }
}
