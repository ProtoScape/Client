...
{
    static ServerPacket aClass114_3842;
	...
	if (!bool)
		...
		.putShort(i_0_);
	    Class348_Sub42_Sub14.queuePacket(42, class348_sub47);
	}
    }
	...
	int i_2_ = class348_sub49.getWord(13638);
	int i_3_ = class348_sub49.getWord(13638);
    ...
    static {
	aClass114_3842 = new ServerPacket(114, 4);
    }
}
