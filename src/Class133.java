...
final class Class133
{
	...
	static ServerPacket aClass114_1914 = new ServerPacket(84, 7);
	static boolean aBoolean1915 = false;
	static int anInt1916;
	static ServerPacket aClass114_1917 = new ServerPacket(20, -2);
				...
				if (i_1_ >= 41) {
					...
					if ((0x10000 & i_0_ ^ 0xffffffff) != -1) {
						...
						for (int i_6_ = 0; i_6_ < i_4_; i_6_++) {
							int i_7_ = class348_sub49_sub2.getWordLE128(-118);
					...
					if ((0x200 & i_0_) != 0) {
						int i_23_ = class348_sub49_sub2.getWordLE128(-107);
						if (i_23_ == 65535)
							i_23_ = -1;
						int i_24_
					...
					if ((i_0_ & 0x20 ^ 0xffffffff) != -1) {
						int i_28_ = class348_sub49_sub2.getWordLE128(-126);
