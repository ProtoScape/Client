...
final class Class324_Sub2 extends AbstractFontRasterizer
{
    ...
    Class324_Sub2(NativeToolkit var_ha_Sub3, BitmapFont class143, ImageSprite[] class207s,
		  boolean bool) {
	super(var_ha_Sub3, class143);
	aHa_Sub3_6494 = var_ha_Sub3;
	int i = 0;
	for (int i_4_ = 0; i_4_ < 256; i_4_++) {
	    ImageSprite class207 = class207s[i_4_];
	...
	if (bool) {
		...
		ImageSprite class207 = class207s[i_6_];
		int i_7_ = ((ImageSprite) class207).indexHeight;
		int i_8_ = ((ImageSprite) class207).indexWidth;
		int i_9_ = i_6_ % 16 * i;
		int i_10_ = i_6_ / 16 * i;
		int i_11_ = i_10_ * i_5_ + i_9_;
		int i_12_ = 0;
		if (((ImageSprite) class207).alphaIndex == null) {
		    byte[] is_13_ = ((ImageSprite) class207).colorIndex;
		    ...
		    byte[] is_16_ = ((ImageSprite) class207).alphaIndex;
		...
		ImageSprite class207 = class207s[i_21_];
		int[] is_22_ = ((ImageSprite) class207).colors;
		byte[] is_23_ = ((ImageSprite) class207).alphaIndex;
		byte[] is_24_ = ((ImageSprite) class207).colorIndex;
		int i_25_ = ((ImageSprite) class207).indexHeight;
		int i_26_ = ((ImageSprite) class207).indexWidth;
	...
	for (int i_36_ = 0; i_36_ < 4; i_36_++) {
		...
		for (int i_38_ = 0; i_38_ < 256; i_38_++) {
		    ImageSprite class207 = class207s[i_38_];
		    int i_39_ = ((ImageSprite) class207).indexHeight;
		    int i_40_ = ((ImageSprite) class207).indexWidth;
		    int i_41_ = ((ImageSprite) class207).heightOffset;
		    int i_42_ = ((ImageSprite) class207).widthOffset;
