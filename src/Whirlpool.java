...
final class Whirlpool
{
	...
	while ((i_38_ ^ 0xffffffff) > -9) {
	    ...
	    dest[destOff] = (byte) (int) (l >>> -494522120);
	    dest[destOff + 1] = (byte) (int) (l >>> -1323727504);
	    dest[2 + destOff] = (byte) (int) (l >>> -1362540312);
	    dest[destOff - -3] = (byte) (int) (l >>> -816276512);
	    dest[destOff + 4] = (byte) (int) (l >>> -1281121832);
	    dest[destOff + 5] = (byte) (int) (l >>> 1026016144);
	    dest[6 + destOff] = (byte) (int) (l >>> -800909304);
	    dest[destOff + 7] = (byte) (int) l;
	    i_38_++;
	    destOff += 8;
	}
    }
