...
final class Class348_Sub20 extends Node
{
    ...
    private OpenGlToolkit aHa_Sub2_6831;
    float aFloat6832;
    int anInt6833;
	...
	aNativeHeapBuffer6840
	    = ((OpenGlToolkit) aHa_Sub2_6831).aNativeHeap7730.a(4 * i_3_, true);
	anInt6834++;
	if (i != 2147483647)
	    aHa_Sub2_6831 = null;
	...
	FloatBuffer class348_sub49_sub1
	    = ((OpenGlToolkit) aHa_Sub2_6831).aClass348_Sub49_Sub1_7798;
	((ByteBuffer) class348_sub49_sub1).position = 0;
	if (((OpenGlToolkit) aHa_Sub2_6831).aBoolean7775) {
	...
	if (i_9_ > 0) {
	    ...
	    aHa_Sub2_6831.method3746(((0x7 & ((s_Sub2) aS_Sub2_6839).anInt8235)
				     ...
				     ((((s_Sub2) aS_Sub2_6839).anInt8235 & 0x8)
				      != 0),
				     112);
	    if (((OpenGlToolkit) aHa_Sub2_6831).aBoolean7846)
