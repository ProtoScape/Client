...
final class Class348_Sub24 extends Node
{
	...
	if (AbstractWorld.aBoolean1712) {
		...
		if (class348_sub45 != null
		    ...
		    int i_2_ = 0;
		    for (AbstractMouseEvent class348_sub45_3_
			     = ((AbstractMouseEvent)
				r_Sub1.aClass262_10479.getFirst(4));
			 class348_sub45_3_ != null;
			 class348_sub45_3_
			     = (AbstractMouseEvent) r_Sub1.aClass262_10479
						    .nextForward((byte) 79)) {
			...
			((BufferedPacket) class348_sub47)
			    ...
			    (105,
			     ((ByteBuffer)
			      (((BufferedPacket) class348_sub47)
			       .buffer)).position + -i_2_);
			Class348_Sub42_Sub14.queuePacket(23, class348_sub47);
		    }
		}
		if (class348_sub45 != null) {
		    ...
		    Class348_Sub42_Sub14.queuePacket(25, class348_sub47);
		}
		...
		if (Class369_Sub3_Sub1.aBoolean10174
		    ...
		    Class348_Sub42_Sub14.queuePacket(-31, class348_sub47);
		}
		if (Class347.aBoolean4278 != Class175.isWindowActive) {
		    ...
		    Class348_Sub42_Sub14.queuePacket(i + -11501,
						    class348_sub47);
		}
		if (!r.aBoolean9719) {
		    Class62.anInt1110++;
			...
			(96,
			 (((ByteBuffer) (((BufferedPacket) class348_sub47)
					     .buffer))
			  .position) + -i_14_);
		    Class348_Sub42_Sub14.queuePacket(i + -11473,
						    class348_sub47);
		    r.aBoolean9719 = true;
		}
		...
		if (Class240.anInt4674 == 10) {
			...
			for (WidgetVariable variable
			    ...
			    if (type == 1) {
				IsaacCipher.globalScriptIntVars[id] = ((WidgetVariable)
				       variable).intArg;
			...
			if ((Class192.playerRights ^ 0xffffffff) < -1
			...
			if (i == 11432) {
				...
				Class348_Sub42_Sub14
				    .queuePacket(i ^ ~0x2cc0, class348_sub47);
			    }
