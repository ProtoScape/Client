...
abstract class AbstractWorld
{
    ...
    static ServerPacket aClass114_1702;
    ...
    final boolean isMembersWorld(boolean bool) {
	anInt1707++;
	if (bool != true)
	    aBoolean1712 = false;
	if ((((AbstractWorld) this).settingFlags & 0x1 ^ 0xffffffff) == -1)
	    return false;
	return true;
    }
    ...
    final boolean isPvpWorld(int i) {
	int i_0_ = 101 / ((54 - i) / 47);
	anInt1699++;
	if ((0x4 & ((AbstractWorld) this).settingFlags) == 0)
	    return false;
	return true;
    }
    ...
    final boolean isLootShareWorld(int i) {
	anInt1703++;
	int i_4_ = -62 % ((i - -5) / 47);
	if ((0x8 & ((AbstractWorld) this).settingFlags ^ 0xffffffff) == -1)
	    return false;
	return true;
    }
	...
	if ((((AbstractWorld) this).settingFlags & 0x2) == 0)
	    return false;
	return true;
    }
    ...
    static {
	aClass114_1702 = new ServerPacket(24, 6);
    }
}
