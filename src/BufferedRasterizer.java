...
final class BufferedRasterizer implements AbstractRasterizer
{
	...
	do {
		...
		if (!(class105 instanceof SoftwareRaster)) {
			...
			= ((AbstractSoftwareRaster) class105_sub3_sub3).width;
		    ((BufferedRasterizer) this).anInt4722
			= ((AbstractSoftwareRaster) class105_sub3_sub3).height;
		    ((BufferedRasterizer) this).anIntArray4731
			= (((BufferedSoftwareRaster) class105_sub3_sub3)
			   .pixelArray);
		} else {
		    SoftwareRaster class105_sub3_sub1
			= (SoftwareRaster) class105;
		    ((BufferedRasterizer) this).anIntArray4731
			= (((SoftwareRaster) class105_sub3_sub1)
			   .anIntArray9933);
		    ((BufferedRasterizer) this).anInt4722
			= ((AbstractSoftwareRaster) class105_sub3_sub1).height;
		    ((BufferedRasterizer) this).anInt4725
			= ((AbstractSoftwareRaster) class105_sub3_sub1).width;
		}
		if (class216 == null)
		    break;
