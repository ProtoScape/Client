...
final class Class285_Sub1 extends Class285 implements Interface5_Impl1
{
    ...
    static final String unformatUsername(String string) {
	anInt8483++;
	if (string == null)
	    return null;
	int i_0_ = 0;
	...
	if ((i_2_ ^ 0xffffffff) > -2 || i_2_ > 12)
	    return null;
	StringBuilder stringbuffer = new StringBuilder(i_2_);
	for (int i_3_ = i_0_; (i_3_ ^ 0xffffffff) > (i_1_ ^ 0xffffffff); i_3_++) {
	    char c = string.charAt(i_3_);
	    if (Class239_Sub29.method1849(c)) {
	...
	int i_5_ = class348_sub49.getWord(13638);
	...
	if (i != 6331)
	    anInt8492 = -14;
	anInt8489++;
	return super.method2123((((NativeOpenGlToolkit) ((Class285) this).aClass377_4759)
				 .aMapBuffer9915),
				i ^ 0x18bb);
    }
	...
	return super.method2120(0,
				(((NativeOpenGlToolkit) ((Class285) this).aClass377_4759)
				 .aMapBuffer9915),
				bool);
    }
    ...
    Class285_Sub1(NativeOpenGlToolkit class377, boolean bool) {
