...
final class Class222
{
    ...
    static GamePacket aClass351_2892 = new GamePacket(39, 8);
    ...
    final synchronized ImageSprite method1610(byte i) {
	anInt2888++;
	ImageSprite class207
	    = (ImageSprite) ((Class166) ((Class222) this).aClass166_2886)
			     .aClass60_2190.method583((long) anInt2891, -70);
	if (class207 != null)
	    return class207;
	class207
	    = ImageSprite.getSprite(((Class166) (((Class222) this)
