...
final class Class182
{
	...
	if (Class320.method2547(i, (byte) 84) && i_5_ == -1391) {
		...
		Client.method107((Class348_Sub40_Sub33.aClass46ArrayArray9427
				  [i]),
				 -1, i_1_, i_10_, i_2_, i_7_, i_0_, i_8_, i_4_,
				 i_3_, i_6_, i_9_);
	    else
		Client.method107(Class369_Sub2.aClass46ArrayArray8584[i], -1,
	...
	anInt2453++;
	return new Class50_Sub4(class348_sub49.getWord(13638),
