...
class Class258_Sub3 extends Class258
{
    ...
    Class258_Sub3(OpenGlToolkit var_ha_Sub2, int i, int i_0_, int i_1_, int i_2_) {
    ...
    Class258_Sub3(OpenGlToolkit var_ha_Sub2, int i, int i_6_, int i_7_, int i_8_,
	...
	OpenGL.glTexSubImage2Di(((Class258) this).anInt4849, 0, i_14_, i_10_,
				i_13_, i, 32993,
				(((OpenGlToolkit) ((Class258) this).aHa_Sub2_4851)
				 .anInt7812),
				is, i_11_);
    ...
    Class258_Sub3(OpenGlToolkit var_ha_Sub2, int i, int i_21_, int i_22_, int i_23_,
    ...
    Class258_Sub3(OpenGlToolkit var_ha_Sub2, int i, int i_32_, int i_33_, int i_34_,
	...
	anInt8544++;
	int i_57_ = (((OpenGlToolkit) ((Class258) this).aHa_Sub2_4851).anInt7641
		     + (-i_52_ - i_51_));
    ...
    Class258_Sub3(OpenGlToolkit var_ha_Sub2, int i, int i_77_, int i_78_, int i_79_,
		  int i_80_) {
	super(var_ha_Sub2, i, 6407, i_80_ * i_79_, false);
	anInt8545 = -1;
	((Class258_Sub3) this).anInt8547 = i_79_;
	((Class258_Sub3) this).anInt8551 = i_80_;
	int i_81_ = (((OpenGlToolkit) ((Class258) this).aHa_Sub2_4851).anInt7641
		     + (-i_78_ + -i_80_));
	((Class258) this).aHa_Sub2_4851.method3771((byte) -111, this);
