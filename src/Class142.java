...
{
    private DirectxToolkit aClass378_8515;
	...
	if (!aBoolean8520
	    && ue.a((((Class142) this).anIDirect3DIndexBuffer8517.Lock
		     (0, anInt8521, !bool ? 0 : 8192,
		      ((DirectxToolkit) aClass378_8515).aGeometryBuffer9811)),
		    false)) {
	    aBoolean8520 = true;
	    return ((DirectxToolkit) aClass378_8515).aGeometryBuffer9811;
	}
	return null;
    }
    ...
    Class142(DirectxToolkit class378, Class68 class68, boolean bool) {
