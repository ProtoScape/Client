...
final class Class286_Sub3 extends Class286
{
	...
	if (aClass61_6222 != null) {
		...
		Class348_Sub42_Sub1.aFloatArray9491[2]
		    = (((OpenGlToolkit) ((Class286) this).aHa_Sub2_3684).aFloat7823
		       * (((OpenGlToolkit) ((Class286) this).aHa_Sub2_3684)
			  .aFloat7768));
		Class348_Sub42_Sub1.aFloatArray9491[0]
		    = (((OpenGlToolkit) ((Class286) this).aHa_Sub2_3684).aFloat7781
		       * (((OpenGlToolkit) ((Class286) this).aHa_Sub2_3684)
			  .aFloat7768));
		Class348_Sub42_Sub1.aFloatArray9491[1]
		    = (((OpenGlToolkit) ((Class286) this).aHa_Sub2_3684).aFloat7768
		       * (((OpenGlToolkit) ((Class286) this).aHa_Sub2_3684)
			  .aFloat7816));
    ...
    static final BufferedPacket createBufferedPacket(GamePacket outgoingPacket, IsaacCipher isaac) {
	try {
	    anInt6230++;
	    BufferedPacket packet = Class300.getBufferedOutgoingPacket();
	    ((BufferedPacket) packet).sizeType = ((GamePacket) outgoingPacket).sizeType;
	...
	if (aClass61_6222 != null) {
	    ...
	    OpenGL.glMatrixMode(5890);
	    if (bool_11_ == false) {
		OpenGL.glLoadMatrixf(((OpenGlToolkit)
		...
		if ((anInt6219 ^ 0xffffffff)
		    != (((OpenGlToolkit) ((Class286) this).aHa_Sub2_3684).anInt7735
			^ 0xffffffff)) {
		    int i = ((((OpenGlToolkit) ((Class286) this).aHa_Sub2_3684)
			      .anInt7735)
			     % 5000 * 128 / 5000);
		    ...
		    if (((Class83) aClass83_6227).aBoolean1442)
			aFloat6225
			    = (float) (((OpenGlToolkit) (((Class286) this)
						   .aHa_Sub2_3684)).anInt7735
				       % 4000) / 4000.0F;
		    else
			OpenGL.glProgramLocalParameter4fARB(34336, 65, 0.0F,
							    0.0F, 0.0F, 1.0F);
		    anInt6219 = (((OpenGlToolkit) ((Class286) this).aHa_Sub2_3684)
				 .anInt7735);
		}
	    }
	}
