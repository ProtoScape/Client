...
abstract class Class135
{
	...
	if (anInt1921 >= i_2_)
	    ...
	    ((OpenGlToolkit) ((Class135) this).aHa_Sub2_1927).anInt7747
		+= -anInt1921 + i_2_;
	    anInt1921 = i_2_;
	}
    }
    ...
    Class135(OpenGlToolkit var_ha_Sub2, int i, byte[] is, int i_4_, boolean bool) {
	try {
	    aBoolean1923 = bool;
	    ...
	    ((OpenGlToolkit) ((Class135) this).aHa_Sub2_1927).anInt7747 += anInt1921;
    ...
    Class135(OpenGlToolkit var_ha_Sub2, int i, Buffer buffer, int i_5_,
	     boolean bool) {
	try {
	    anInt1930 = i;
	    anInt1921 = i_5_;
