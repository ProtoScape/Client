...
final class Class367_Sub2 extends Class367
{
    ...
    private NativeOpenGlToolkit aClass377_7296;
	...
	if (string != null) {
	    ...
	    String string_8_ = Class285_Sub1.unformatUsername(string);
	    if (string_8_ != null) {
		if (bool != true)
		    method3536(9, 65, -72, 107, null);
		for (int i = 0;
		     ((i ^ 0xffffffff)
		      > (Class348_Sub42_Sub12.ignoreListLength ^ 0xffffffff));
		     i++) {
		    String string_9_ = ObjectDefinition.ignoreListUsernames[i];
		    if (string_9_.startsWith("*"))
			string_9_ = string_9_.substring(1);
		    string_9_ = Class285_Sub1.unformatUsername(string_9_);
		    if (string_9_ != null && string_9_.equals(string_8_)) {
			Class348_Sub42_Sub12.ignoreListLength--;
			for (int i_10_ = i;
			     Class348_Sub42_Sub12.ignoreListLength > i_10_; i_10_++) {
			    ObjectDefinition.ignoreListUsernames[i_10_]
				= ObjectDefinition.ignoreListUsernames[i_10_ + 1];
			    Class122.aStringArray1808[i_10_]
				= Class122.aStringArray1808[1 + i_10_];
			    Class348_Sub40_Sub21.ignoreListGamenames[i_10_]
