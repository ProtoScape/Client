...
final class NativeOpenGlToolkit extends NativeToolkit
{
	...
	anInt9887++;
	int i_20_
	    = ((NativeOpenGlToolkit) this).anIntArray9927[((NativeToolkit) this).anInt8175];
	if ((i_20_ ^ 0xffffffff) != -1) {
	    ((NativeOpenGlToolkit) this).anIntArray9927[((NativeToolkit) this).anInt8175] = 0;
	...
	if (i_27_ != 3089)
	    ((NativeOpenGlToolkit) this).anIntArray9927 = null;
	anInt9850++;
	Class348_Sub35 class348_sub35 = new Class348_Sub35(i);
	...
	if (i != 25644)
	    ((NativeOpenGlToolkit) this).aBoolean9921 = false;
	anInt9871++;
    ...
    NativeOpenGlToolkit(OpenGL opengl, Canvas canvas, long l, d var_d, IndexLoader class45,
	     int i) {
	...
	try {
		...
		((NativeOpenGlToolkit) this).aBoolean9920
		...
		((NativeOpenGlToolkit) this).aBoolean9921
		    = anOpenGL9856.a("GL_ARB_vertex_shader");
		((NativeOpenGlToolkit) this).aBoolean9923
		    = anOpenGL9856.a("GL_ARB_vertex_program");
		((NativeOpenGlToolkit) this).aBoolean9922
		    = anOpenGL9856.a("GL_ARB_fragment_shader");
		anOpenGL9856.a("GL_ARB_fragment_program");
		((NativeOpenGlToolkit) this).anIntArray9927
		    = new int[((NativeToolkit) this).anInt8090];
		((NativeOpenGlToolkit) this).anInt9918 = Stream.c() ? 33639 : 5121;
		if (aString9916.indexOf("radeon") != -1) {
			...
			if (i_34_ >= 7000 && i_34_ <= 7999)
			    ((NativeOpenGlToolkit) this).aBoolean9920 = false;
		...
		if (((NativeOpenGlToolkit) this).aBoolean9920) {
		    try {
	...
	try {
	    anInt9854++;
	    if (bool != true)
		((NativeOpenGlToolkit) this).aBoolean9921 = true;
	    int i_51_;
	    int i_52_;
	...
	try {
	    ...
	    Long var_long = (Long) object;
	    if (i != 1)
		((NativeOpenGlToolkit) this).anInt9918 = -120;
	...
	if (i != 0)
	    ((NativeOpenGlToolkit) this).anInt9918 = 74;
    }
	...
	for (int i_93_ = 0; (i_92_ ^ 0xffffffff) < (i_93_ ^ 0xffffffff);
	    ...
	    OpenGL.glReadPixelsi(i,
				 (-1 + (-i_93_ + -i_90_)
				  + ((NativeToolkit) this).anInt7962),
				 i_91_, 1, 32993, ((NativeOpenGlToolkit) this).anInt9918,
				 is, i_91_ * i_93_);
	return is;
    }
