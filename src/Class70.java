...
final class Class70
{
	...
	if (WidgetVariable.currentLoadingStage != null) {
	    ...
	    ObjectDefinition.loadingHandler.setLoadingStage(WidgetVariable.currentLoadingStage, ((LoadingStage) WidgetVariable.currentLoadingStage).mainText.getLanguageText(Class348_Sub33.gameLanguage), ((LoadingStage) WidgetVariable.currentLoadingStage).initialPercent, WorldInfo.loadingStartTime, false);
