...
final class Class348_Sub42_Sub8_Sub2 extends Class348_Sub42_Sub8
{
	...
	static EntityPacket aClass74_10437 = new EntityPacket(0, 3);
	...
	static final boolean parseIncomingPacket(boolean bool) throws IOException {
		...
		if (Class348_Sub3.currentIncomingPacket == null) {
			...
			ServerPacket[] packets = Class14_Sub3.getIncomingPackets(-11271);
			...
			Class348_Sub40_Sub25.currentPacketSize = ((ServerPacket) Class348_Sub3.currentIncomingPacket).size;
		}
		...
		if (IOException_Sub1.serverPacket42 == Class348_Sub3.currentIncomingPacket) {
			Class43.setClientSettings(Class299.gameBuffer.getJstr(), true);
			Class348_Sub3.currentIncomingPacket = null;
			return true;
		}
		if (Class348_Sub3.currentIncomingPacket == Class348_Sub42_Sub3.aClass114_9503) {
			int settingFlags = Class299.gameBuffer.getUByte();
			boolean updateEntry = (settingFlags & 0x1) == 1;
			String str0 = Class299.gameBuffer.getJstr();
			String str1 = Class299.gameBuffer.getJstr();
			if (str1.equals(""))
                            str1 = str0;
			String str2 = Class299.gameBuffer.getJstr();
			String str3 = Class299.gameBuffer.getJstr();
			if (str3.equals(""))
                            str3 = str2;
			if (updateEntry) {
                            for (int i_7_ = 0; ((Class348_Sub42_Sub12.ignoreListLength ^ 0xffffffff) < (i_7_ ^ 0xffffffff)); i_7_++) {
                                if (Class122.aStringArray1808[i_7_].equals(str3)) {
                                    ObjectDefinition.ignoreListUsernames[i_7_] = str0;
                                    Class122.aStringArray1808[i_7_] = str1;
                                    Class348_Sub40_Sub21.ignoreListGamenames[i_7_] = str2;
                                    aa_Sub2.aStringArray5197[i_7_] = str3;
                                    break;
                                }
                            }
			} else {
                            ObjectDefinition.ignoreListUsernames[Class348_Sub42_Sub12.ignoreListLength] = str0;
                            Class122.aStringArray1808[Class348_Sub42_Sub12.ignoreListLength] = str1;
                            Class348_Sub40_Sub21.ignoreListGamenames[(Class348_Sub42_Sub12.ignoreListLength)] = str2;
                            aa_Sub2.aStringArray5197[Class348_Sub42_Sub12.ignoreListLength] = str3;
                            Class367_Sub3.aBooleanArray7304[Class348_Sub42_Sub12.ignoreListLength] = Class139.bitAnd(settingFlags, 2) == 2;
                            Class348_Sub42_Sub12.ignoreListLength++;
			}
			Class126.anInt4985 = LoadingHandler.anInt3918;
			Class348_Sub3.currentIncomingPacket = null;
			return true;
		}
		if (Class348_Sub3.currentIncomingPacket == Class318_Sub6.serverPacket82) {
			DummyInputstream.parseEntityPacket(Class348_Sub26.entityPacket4, (byte) 8);
			Class348_Sub3.currentIncomingPacket = null;
			return true;
		}
		if (HashTable.aClass114_4388 == Class348_Sub3.currentIncomingPacket) {
			byte i = Class299.gameBuffer.getByte();
			int i_8_ = Class299.gameBuffer.getWordLE128(-111);
		...
		if (Class135_Sub1.aClass114_4707 == Class348_Sub3.currentIncomingPacket) {
			...
			int i_9_ = Class299.gameBuffer.getDword();
			Class318_Sub1_Sub1_Sub1.method2397((byte) -124);
			Class348_Sub41 class348_sub41 = ((Class348_Sub41) Class125.aClass356_4915.get((long) i_9_));
		...
		if (Class239.aClass114_3135 == Class348_Sub3.currentIncomingPacket) {
			int v0 = Class299.gameBuffer.method3393((byte) 62);
			int v1 = Class299.gameBuffer.method3364((byte) -126);
			Class318_Sub1_Sub1_Sub1.method2397((byte) -124);
			Class348_Sub15.method2813(true, v0, v1);
			Class348_Sub3.currentIncomingPacket = null;
			return true;
		}
		...
		if (Class348_Sub3.currentIncomingPacket == Class22.aClass114_330) {
			boolean hasGameName = Class299.gameBuffer.getUByte() == 1;
			String username = Class299.gameBuffer.getJstr();
			String gameName = username;
			if (hasGameName)
                            gameName = Class299.gameBuffer.getJstr();
			long l = Class299.gameBuffer.getLong();
			long l_17_ = (long) Class299.gameBuffer.getShort();
			long l_18_ = (long) Class299.gameBuffer.getTri();
				...
				do {
					...
					if (rights <= 1) {
						if ((Class348_Sub40_Sub3.aBoolean9103
							...
							bool_20_ = true;
						else if (GamePacket.method3455(gameName, 28280))
							bool_20_ = true;
					}
				} while (false);
			if (!bool_20_ && Class250.anInt3227 == 0) {
				...
				String string_22_ = (Class59_Sub2_Sub2.method572((Class348_Sub40_Sub32.method3136((byte) 64, Class299.gameBuffer)), 23034));
				if ((rights ^ 0xffffffff) == -3 || rights == 3)
					Class318_Sub1_Sub3_Sub5.handleMessage("<img=1>" + gameName, string_22_, -1, "<img=1>" + username, Class239_Sub16.method1788((byte) -76, l), 9, 0, username);
				else if (rights != 1)
					Class318_Sub1_Sub3_Sub5.handleMessage(gameName, string_22_, -1, username, Class239_Sub16.method1788((byte) -83, l), 9, 0, username);
				else
					Class318_Sub1_Sub3_Sub5.handleMessage("<img=0>" + gameName, string_22_, -1, "<img=0>" + username, Class239_Sub16.method1788((byte) -75, l), 9, 0, username);
			}
			Class348_Sub3.currentIncomingPacket = null;
			return true;
		}
		...
		if (Class348_Sub3.currentIncomingPacket == DummyInputstream.aClass114_82) {
			DummyInputstream.parseEntityPacket(Class39.aClass74_515, (byte) 8);
			Class348_Sub3.currentIncomingPacket = null;
			return true;
		}
		...
		if (Class369_Sub2.aClass114_8590 == Class348_Sub3.currentIncomingPacket) {
			DummyInputstream.parseEntityPacket(Class374.aClass74_4537, (byte) 8);
			Class348_Sub3.currentIncomingPacket = null;
			return true;
		}
		if (Class348_Sub3.currentIncomingPacket == Class252.aClass114_3240) {
			int i = Class299.gameBuffer.getWordLE128(-117);
		...
		if (Class322.aClass114_4027 == Class348_Sub3.currentIncomingPacket) {
			...
			ItemDefinition class213 = ToolkitException.itemLoader.getItemDefinition(-126, i);
		...
		if (Class133.aClass114_1917 == Class348_Sub3.currentIncomingPacket) {
			...
			Class199.anIntArray2633[Class139.bitAnd(31,
		...
		if (Class348_Sub3.currentIncomingPacket == Class239_Sub20.aClass114_6056) {
			...
			if ((i_40_ >> 1898360446 ^ 0xffffffff) == -1) {
				...
				int i_60_ = (i_40_ & 0x33705717) >> -970295684;
								int i_61_
								= -za_Sub2.baseRegionX + ((0xffff4fe & i_40_) >> -516715090);
								int i_62_ = -Class90.baseRegionY + (0x3fff & i_40_);
								if ((i_61_ ^ 0xffffffff) <= -1 && (i_62_ ^ 0xffffffff) <= -1
										&& Class367_Sub4.mapSizeX > i_61_
										&& Class348_Sub40_Sub3.mapSizeY > i_62_) {
		...
		if (Class348_Sub3.currentIncomingPacket == Class63.aClass114_1120) {
			int i = Class299.gameBuffer.getWordLE128(-116);
			String string
			= Class299.gameBuffer.getJstr();
			Class318_Sub1_Sub1_Sub1.method2397((byte) -125);
			NativeOpenGlToolkit.method3965(string, i, 2);
			Class348_Sub3.currentIncomingPacket = null;
			return true;
		}
		if (Class348_Sub3.currentIncomingPacket == EntityPacket.aClass114_1234) {
			Class24.anInt359
		...
		if (GameFont.aClass114_4331 == Class348_Sub3.currentIncomingPacket) {
			...
			boolean bool_66_ = Class299.gameBuffer.getUByte() == 1;
			String string_67_;
			if (!bool_66_)
				string_67_ = string;
			else
				string_67_ = Class299.gameBuffer.getJstr();
			int i = Class299.gameBuffer.getShort();
			...
			if ((i_68_ ^ 0xffffffff) == 127)
				bool_69_ = true;
			if (bool_69_) {
				if (Class37.amountClanChatUsers == 0) {
                                    Class348_Sub3.currentIncomingPacket = null;
                                    return true;
				}
				boolean bool_70_ = false;
				int i_71_;
				for (i_71_ = 0; Class37.amountClanChatUsers > i_71_; i_71_++) {
                                    if (((ClanChatPlayer) Class169.aClass19Array2261[i_71_]).aString306.equals(string_67_) && i == (((ClanChatPlayer) Class169.aClass19Array2261[i_71_]).anInt308))
                                            break;
				}
				if ((i_71_ ^ 0xffffffff) > (Class37.amountClanChatUsers ^ 0xffffffff)) {
					for (/**/; (i_71_ ^ 0xffffffff) > (-1 + Class37.amountClanChatUsers
							^ 0xffffffff); i_71_++)
						Class169.aClass19Array2261[i_71_]
						                           = Class169.aClass19Array2261[i_71_ - -1];
					Class37.amountClanChatUsers--;
					Class169.aClass19Array2261[Class37.amountClanChatUsers] = null;
				}
			} else {
				String string_72_ = Class299.gameBuffer.getJstr();
				ClanChatPlayer class19 = new ClanChatPlayer();
				((ClanChatPlayer) class19).aString306 = string_67_;
				((ClanChatPlayer) class19).aString314 = string;
				((ClanChatPlayer) class19).aString312 = Class285_Sub1.unformatUsername(((ClanChatPlayer) class19).aString306);
				((ClanChatPlayer) class19).aString313 = string_72_;
				((ClanChatPlayer) class19).anInt308 = i;
				((ClanChatPlayer) class19).aByte310 = i_68_;
				int i_73_;
				for (i_73_ = -1 + Class37.amountClanChatUsers; (i_73_ ^ 0xffffffff) <= -1; i_73_--) {
					int i_74_ = ((ClanChatPlayer) Class169.aClass19Array2261[i_73_]).aString312.compareTo(((ClanChatPlayer) class19).aString312);
					if (i_74_ == 0) {
						((ClanChatPlayer) Class169.aClass19Array2261[i_73_]).anInt308
						= i;
						((ClanChatPlayer) Class169.aClass19Array2261[i_73_]).aByte310
						= i_68_;
						((ClanChatPlayer) Class169.aClass19Array2261[i_73_])
						.aString313
						= string_72_;
				...
				if (Class169.aClass19Array2261.length <= Class37.amountClanChatUsers) {
					Class348_Sub3.currentIncomingPacket = null;
					return true;
				}
				for (int i_75_ = Class37.amountClanChatUsers - 1; (i_73_ ^ 0xffffffff) > (i_75_ ^ 0xffffffff); i_75_--)
					Class169.aClass19Array2261[1 + i_75_] = Class169.aClass19Array2261[i_75_];
				if ((Class37.amountClanChatUsers ^ 0xffffffff) == -1)
					Class169.aClass19Array2261 = new ClanChatPlayer[100];
				Class169.aClass19Array2261[i_73_ + 1] = class19;
				Class37.amountClanChatUsers++;
				if (string_67_.equals(((Player) (Class132.localPlayer)).aString10544))
                                    Class119_Sub1.aByte4702 = i_68_;
			}
			GameMode.anInt2986 = LoadingHandler.anInt3918;
			Class348_Sub3.currentIncomingPacket = null;
					...
					if (((Class302) class302).anInt3831 >= 0
						...
						if ((((Class302) class302).anInt3840 ^ 0xffffffff) != -2
							...
							if (((Class302) class302).anInt3840 >= 2
								...
								+= (Class299.gameBuffer
										.getShort() + -za_Sub2.baseRegionX
										<< 1394439945);
								((Class302) class302).anInt3832
								+= (Class299.gameBuffer
										.getShort() - Class90.baseRegionY
										<< -673089399);
		...
		if (Class172.serverPacket60 == Class348_Sub3.currentIncomingPacket) {
		...
		if (Class264.aClass114_3371 == Class348_Sub3.currentIncomingPacket) {
			DummyInputstream.parseEntityPacket(Class59_Sub1_Sub2.aClass74_8662,
					(byte) 8);
			Class348_Sub3.currentIncomingPacket = null;
			return true;
		}
		if (Class348_Sub3.currentIncomingPacket == Class367_Sub4.aClass114_7324) {
			...
			int i_79_ = Class299.gameBuffer.getWordLE128(-120);
		...
		if (Class5_Sub2.aClass114_8365 == Class348_Sub3.currentIncomingPacket) {
			...
			if ((rights ^ 0xffffffff) >= -2) {
				if (Class348_Sub40_Sub3.aBoolean9103 && !Class133.aBoolean1915 || Class50_Sub2.isQuickchat)
                                    bool_83_ = true;
				else if ((rights ^ 0xffffffff) >= -2 && GamePacket.method3455(string_82_, 28280))
                                    bool_83_ = true;
			}
		...
		if (Class15.aClass114_229 == Class348_Sub3.currentIncomingPacket) {
			DummyInputstream.parseEntityPacket(Class286_Sub1.aClass74_6201, (byte) 8);
			Class348_Sub3.currentIncomingPacket = null;
			return true;
		}
		...
		if (Class312.aClass114_3925 == Class348_Sub3.currentIncomingPacket) {
			DummyInputstream.parseEntityPacket(aClass74_10437, (byte) 8);
			Class348_Sub3.currentIncomingPacket = null;
			return true;
		}
				...
				do {
					...
					if ((rights ^ 0xffffffff) >= -2) {
						if ((Class348_Sub40_Sub3.aBoolean9103
								...
								|| Class50_Sub2.isQuickchat)
							bool_101_ = true;
						else if (GamePacket.method3455(string_98_, 28280))
							bool_101_ = true;
					}
				} while (false);
		...
		if (Class348_Sub42_Sub8.serverPacket72
				== Class348_Sub3.currentIncomingPacket) {
			if (r.anInt9721 != -1)
		...
		if (RequiredElement.incomingPacket93 == Class348_Sub3.currentIncomingPacket) {
			AbstractWorld.readClassCheckPacket(Class348_Sub40_Sub25.currentPacketSize, Class299.gameBuffer, Class348_Sub23_Sub1.signlink, 110);
			Class348_Sub3.currentIncomingPacket = null;
			return true;
		}
		...
		if (ItemLoader.aClass114_3265 == Class348_Sub3.currentIncomingPacket) {
			...
			while ((Class348_Sub40_Sub25.currentPacketSize ^ 0xffffffff)
					< ((((ByteBuffer) Class299.gameBuffer)
							.position)
							^ 0xffffffff)) {
				EntityPacket class74
				= (ItemLoader.method1929((byte) -19)
						[Class299.gameBuffer.getUByte()]);
				DummyInputstream.parseEntityPacket(class74, (byte) 8);
			}
			Class348_Sub3.currentIncomingPacket = null;
			return true;
		}
		if (Class271.aClass114_3467 == Class348_Sub3.currentIncomingPacket) {
			int i = Class299.gameBuffer.getWord(13638);
			int i_110_
			= Class299.gameBuffer.getDword();
			int i_111_
		...
		if (Class167.aClass114_2196 == Class348_Sub3.currentIncomingPacket) {
			...
			while_219_:
				do {
					...
					if ((i ^ 0xffffffff) >= -2
							&& GamePacket.method3455(string_114_, 28280))
						bool_119_ = true;
				} while (false);
		...
		if (BufferedPacket.aClass114_7124 == Class348_Sub3.currentIncomingPacket) {
			...
			i_122_ -= za_Sub2.baseRegionX;
			int i_123_ = 0x3fff & i;
			i_123_ -= Class90.baseRegionY;
			if (i_122_ >= 0) {
				if (Class367_Sub4.mapSizeX <= i_122_)
					i_122_ = Class367_Sub4.mapSizeX;
			} else
				i_122_ = 0;
			Class9.anInt167 = (i_122_ << -1075184215) - -256;
			if ((i_123_ ^ 0xffffffff) <= -1) {
				if (i_123_ >= Class348_Sub40_Sub3.mapSizeY)
					i_123_ = Class348_Sub40_Sub3.mapSizeY;
			} else
				i_123_ = 0;
		...
		if (Class133.aClass114_1914 == Class348_Sub3.currentIncomingPacket) {
			DummyInputstream.parseEntityPacket(Class348_Sub40_Sub38.aClass74_9475,
					(byte) 8);
			Class348_Sub3.currentIncomingPacket = null;
			return true;
		}
		if (Class348_Sub3.currentIncomingPacket == FileIndexTracker.aClass114_4798) {
			int i = Class299.gameBuffer.getWordLE128(-107);
			if (i == 65535)
				i = -1;
			int i_125_
			...
			int i_131_ = i_129_ >> -1815164786 & 0x3fff;
				...
				i_131_ -= za_Sub2.baseRegionX;
				i_132_ -= Class90.baseRegionY;
		...
		if (Class348_Sub3.currentIncomingPacket == Class348_Sub42_Sub8.aClass114_9550) {
			DummyInputstream.parseEntityPacket(Class327.aClass74_4098, (byte) 8);
			Class348_Sub3.currentIncomingPacket = null;
			return true;
		}
		...
		if (ToolkitInfo.aClass114_4477 == Class348_Sub3.currentIncomingPacket) {
			...
			int i_134_
			= Class299.gameBuffer.getShort();
			int i_135_ = Class299.gameBuffer.getWordLE128(-109);
		...
		if (Class239_Sub21.aClass114_6058 == Class348_Sub3.currentIncomingPacket) {
			DummyInputstream.parseEntityPacket(Class186.aClass74_2491, (byte) 8);
			Class348_Sub3.currentIncomingPacket = null;
			return true;
		}
		if (Class176.aClass114_2331 == Class348_Sub3.currentIncomingPacket) {
			Class348_Sub42_Sub12.ignoreListLength
			= Class299.gameBuffer.getUByte();
			for (int i = 0; Class348_Sub42_Sub12.ignoreListLength > i; i++) {
				ObjectDefinition.ignoreListUsernames[i] = Class299
				.gameBuffer
				.getJstr();
				...
				if (Class122.aStringArray1808[i].equals(""))
					Class122.aStringArray1808[i] = ObjectDefinition.ignoreListUsernames[i];
				Class348_Sub40_Sub21.ignoreListGamenames[i]
				                                      = Class299.gameBuffer.getJstr();
		...
		if (Class348_Sub3.currentIncomingPacket == Class166.aClass114_2183) {
			int i = Class299.gameBuffer.getWordLE128(-121);
			if (i == 65535)
				i = -1;
			String string
			= Class299.gameBuffer.getJstr();
		...
		if (Class128.aClass114_1871 == Class348_Sub3.currentIncomingPacket) {
			int type = Class299.gameBuffer.getSmartB();
			...
			if (type == 99)
                            ClientApplet.addConsoleMessage(messageStr);
			else {
				if (!subSubStr.equals("") && GamePacket.method3455(subSubStr, 28280)) {
                                    Class348_Sub3.currentIncomingPacket = null;
                                    return true;
				}
		...
		if (Class348_Sub3.currentIncomingPacket == AbstractMouseEvent.aClass114_7105) {
			int i = Class299.gameBuffer.getUByte();
		...
		if (Class348_Sub3.currentIncomingPacket == AbstractWorld.aClass114_1702) {
			int i = Class299.gameBuffer.getWord(13638);
			int i_143_ = Class299.gameBuffer.method3343((byte) 82);
			Class318_Sub1_Sub1_Sub1.method2397((byte) -126);
		...
		if (Class348_Sub3.currentIncomingPacket == AbstractMouseEvent.aClass114_7106) {
			while ((((ByteBuffer) Class299.gameBuffer).position) < Class348_Sub40_Sub25.currentPacketSize) {
				boolean bool_149_
				= Class299.gameBuffer.getUByte() == 1;
				...
				for (int i_154_ = 0;
				((Class348_Sub40_Sub30.friendListLength ^ 0xffffffff)
						< (i_154_ ^ 0xffffffff));
				i_154_++) {
					if (!bool_149_) {
						if (string.equals(Class83.friendListUsernames[i_154_])) {
							...
							Class286_Sub2.friendListGamenames[i_154_]
							                               = string_150_;
							Class285.clanChatWorld[i_154_] = string_152_;
							Class172.clanChatRanking[i_154_] = i_151_;
							string = null;
							Class122.aBooleanArray1806[i_154_] = bool_153_;
							break;
						}
					} else if (string_150_
							.equals(Class83.friendListUsernames[i_154_])) {
						Class83.friendListUsernames[i_154_] = string;
						Class286_Sub2.friendListGamenames[i_154_] = string_150_;
						string = null;
						break;
					}
				}
				if (string != null
						&& (Class348_Sub40_Sub30.friendListLength ^ 0xffffffff) > -201) {
					Class83.friendListUsernames[Class348_Sub40_Sub30.friendListLength]
					                         = string;
					Class286_Sub2.friendListGamenames[(Class348_Sub40_Sub30
							.friendListLength)]
							= string_150_;
					AbstractToolkit.anIntArray4578[Class348_Sub40_Sub30.friendListLength] = i;
					Class285.clanChatWorld[Class348_Sub40_Sub30.friendListLength]
					                          = string_152_;
					Class172.clanChatRanking[Class348_Sub40_Sub30.friendListLength]
					                        = i_151_;
					Class122.aBooleanArray1806[Class348_Sub40_Sub30.friendListLength]
					                           = bool_153_;
					Class348_Sub40_Sub30.friendListLength++;
				}
			}
			Class125.socialListStates = 2;
			Class126.anInt4985 = LoadingHandler.anInt3918;
			boolean bool_156_ = false;
			int i = Class348_Sub40_Sub30.friendListLength;
			while ((i ^ 0xffffffff) < -1) {
				...
				for (int i_157_ = 0; i > i_157_; i_157_++) {
					if (((((ConnectionMode) Class3.currentConnection).portOffset
						...
						String string = Class285.clanChatWorld[i_157_];
						Class285.clanChatWorld[i_157_]
						                          = Class285.clanChatWorld[1 + i_157_];
						Class285.clanChatWorld[1 + i_157_] = string;
						String string_159_ = Class83.friendListUsernames[i_157_];
						Class83.friendListUsernames[i_157_]
						                         = Class83.friendListUsernames[i_157_ + 1];
						Class83.friendListUsernames[i_157_ + 1] = string_159_;
						String string_160_
						= Class286_Sub2.friendListGamenames[i_157_];
						Class286_Sub2.friendListGamenames[i_157_]
						                               = Class286_Sub2.friendListGamenames[i_157_ + 1];
						Class286_Sub2.friendListGamenames[i_157_ - -1]
						                               = string_160_;
						int i_161_ = Class172.clanChatRanking[i_157_];
						Class172.clanChatRanking[i_157_]
						                        = Class172.clanChatRanking[1 + i_157_];
						Class172.clanChatRanking[i_157_ + 1] = i_161_;
		...
		if (Class348_Sub3.currentIncomingPacket == Class280.aClass114_3641) {
			DummyInputstream.parseEntityPacket(Class348_Sub35.aClass74_6977, (byte) 8);
			Class348_Sub3.currentIncomingPacket = null;
			return true;
		}
		...
		// 19 - region
		if (Class348_Sub3.currentIncomingPacket == Class20.serverPacket19) {
			Class348_Sub40_Sub26.parseSetRegionPacket(-86);
			Class348_Sub3.currentIncomingPacket = null;
			return false;
		}
		...
		if (Class205.aClass114_2693 == Class348_Sub3.currentIncomingPacket) {
			...
			while_220_:
				do {
					...
					if ((i ^ 0xffffffff) >= -2
							&& GamePacket.method3455(string_175_, 28280))
						bool_179_ = true;
				} while (false);
		...
		if (Class348_Sub3.currentIncomingPacket == Class127_Sub1.serverPacket18) {
			Class348_Sub3.currentIncomingPacket = null;
			Class125.socialListStates = 1;
			Class126.anInt4985 = LoadingHandler.anInt3918;
			return true;
		}
		if (Class348_Sub3.currentIncomingPacket == Class176.serverPacket80) {
			Class318_Sub1_Sub1_Sub1.method2397((byte) -125);
		...
		if (Class348_Sub3.currentIncomingPacket == Class239_Sub14.aClass114_5992) {
			DummyInputstream.parseEntityPacket(Class265.aClass74_4689, (byte) 8);
			Class348_Sub3.currentIncomingPacket = null;
			return true;
		}
		if (Class348_Sub38.aClass114_7015 == Class348_Sub3.currentIncomingPacket) {
			...
			class348_sub37 = ((Class348_Sub37)
				...
				int i_189_ = i_188_ + -za_Sub2.baseRegionX;
				int i_190_
				= (int) (0x3fffL & (((Node) class348_sub37).nodeKey
						>> -554737970));
				int i_191_ = -Class90.baseRegionY + i_190_;
		...
		if (Class348_Sub3.currentIncomingPacket == Class239_Sub15.aClass114_5997) {
			...
			for (int i_192_ = 0; i_192_ < 4; i_192_++)
				is[i_192_] = Class299.gameBuffer.getShort();
			int i_193_ = Class299.gameBuffer.readLEShort(false);
			Class348_Sub22 class348_sub22 = ((Class348_Sub22) Class282.aClass356_3654.get((long) i_193_));
			if (class348_sub22 != null)
		...
		if (Class348_Sub3.currentIncomingPacket == Class348_Sub40_Sub22.aClass114_9285) {
			IntegerVarScriptSettingLoader.anInt3306 = Class299.gameBuffer.getUByte();
			Class348_Sub3.currentIncomingPacket = null;
			return true;
		}
		if (Class348_Sub40_Sub24.aClass114_9324
			...
			int i_194_
			= Class299.gameBuffer.method3342();
			int i_195_ = Class299.gameBuffer.getWordLE128(-127);
			if (i_195_ == 65535)
				i_195_ = -1;
		...
		if (Class321.aClass114_4015 == Class348_Sub3.currentIncomingPacket) {
			...
			int i_196_ = Class299.gameBuffer.getWordLE128(-124);
			if ((i_196_ ^ 0xffffffff) == -65536)
				i_196_ = -1;
			int i_197_ = Class299.gameBuffer.method3329((byte) 21);
		...
		if (Class348_Sub3.currentIncomingPacket == Class47.aClass114_843) {
			DummyInputstream.parseEntityPacket(Class91.aClass74_1519, (byte) 8);
			Class348_Sub3.currentIncomingPacket = null;
			return true;
		}
		...
		if (Class348_Sub3.currentIncomingPacket == ArchiveLoader.serverPacket28) {
			((ByteBuffer) Class299.gameBuffer).position += 28;
			if (Class299.gameBuffer.isChecksumValid(-25541))
				Class179.writeClientSignature((((ByteBuffer) Class299.gameBuffer).position) - 28, (byte) -126, Class299.gameBuffer);
			Class348_Sub3.currentIncomingPacket = null;
			return true;
		}
		...
		if (Class185.aClass114_2483 == Class348_Sub3.currentIncomingPacket) {
			...
			Class199.anIntArray2632[Class139.bitAnd(31, Class326.anInt4086++)] = i_214_;
			Class348_Sub3.currentIncomingPacket = null;
			return true;
		}
		if (ClanChatPlayer.aClass114_315 == Class348_Sub3.currentIncomingPacket) {
			DummyInputstream.parseEntityPacket(ModelPolygon.aClass74_2157, (byte) 8);
			Class348_Sub3.currentIncomingPacket = null;
			return true;
		}
		if (Class28.aClass114_4998 == Class348_Sub3.currentIncomingPacket) {
			...
			Class199.anIntArray2633[Class139.bitAnd(31, AlternativeFontLoader.anInt1631++)] = i;
			Class348_Sub3.currentIncomingPacket = null;
			return true;
		}
		...
		if (Class367_Sub3.aClass114_7301 == Class348_Sub3.currentIncomingPacket) {
			...
			if (i <= 1 && GamePacket.method3455(string_228_, 28280))
				bool_230_ = true;
		...
		if (Class348_Sub3.currentIncomingPacket == OffscreenPlayer.aClass114_4421) {
			...
			Class37.amountClanChatUsers = i;
			ClanChatPlayer[] class19s = new ClanChatPlayer[100];
			for (int i_234_ = 0; Class37.amountClanChatUsers > i_234_; i_234_++) {
				class19s[i_234_] = new ClanChatPlayer();
				((ClanChatPlayer) class19s[i_234_]).aString314
				= Class299.gameBuffer
				.getJstr();
				bool_233_
				= Class299.gameBuffer.getUByte() == 1;
				if (!bool_233_)
					((ClanChatPlayer) class19s[i_234_]).aString306
					= ((ClanChatPlayer) class19s[i_234_]).aString314;
				else
					((ClanChatPlayer) class19s[i_234_]).aString306
					= Class299.gameBuffer
					.getJstr();
				((ClanChatPlayer) class19s[i_234_]).aString312
				= Class285_Sub1.unformatUsername((((ClanChatPlayer) class19s[i_234_])
						.aString306));
				((ClanChatPlayer) class19s[i_234_]).anInt308
				= Class299.gameBuffer.getShort();
				((ClanChatPlayer) class19s[i_234_]).aByte310
				= Class299.gameBuffer.getByte();
				((ClanChatPlayer) class19s[i_234_]).aString313
				= Class299.gameBuffer
				.getJstr();
				if (((ClanChatPlayer) class19s[i_234_]).aString306.equals
						(((Player)
								Class132.localPlayer)
								.aString10544))
			...
			int i_236_ = Class37.amountClanChatUsers;
			while (i_236_ > 0) {
				i_236_--;
				bool_235_ = true;
				for (int i_237_ = 0; i_236_ > i_237_; i_237_++) {
					if (((((ClanChatPlayer) class19s[i_237_]).aString312.compareTo
							(((ClanChatPlayer) class19s[1 + i_237_]).aString312))
							^ 0xffffffff)
							< -1) {
						ClanChatPlayer class19 = class19s[i_237_];
