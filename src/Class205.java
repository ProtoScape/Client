...
final class Class205
{
    ...
    static {
	aClass351_2686 = new GamePacket(41, -1);
	aClass351_2691 = new GamePacket(46, 2);
	aClass348_Sub44_2692 = new Class348_Sub44(0, -1);
	anIntArray2694 = new int[4096];
	aClass114_2693 = new ServerPacket(94, -1);
    }
}
