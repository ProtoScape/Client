...
final class Class84
{
	...
	if ((Class174.aClass105_2309 == null
		...
		= var_ha.createRasterForSprite(class207, true);
	    class207.reflectY();
	    NativeLibTracker.aClass105_4808 = var_ha.createRasterForSprite(class207, true);
		...
		= var_ha.createRasterForSprite(class207_29_, true);
	    class207_29_.reflectY();
	    AbstractWorld.aClass105_1706 = var_ha.createRasterForSprite(class207_29_, true);
	}
	anInt1454++;
	if (Class174.aClass105_2309 != null
	    && WidgetVariable.aClass105_9658 != null
		...
		(i_24_, (-WidgetVariable.aClass105_9659.getHeight()
			 + i_28_ + i_26_));
	    AbstractWorld.aClass105_1706.method974
		(i_24_ + (i_25_
