...
final class Class286_Sub1 extends Class286
{
    ...
    static EntityPacket aClass74_6201 = new EntityPacket(9, 19);
	...
	if (bool == false) {
		...
		OpenGL.glBindProgramARB
		    (34336,
		     ((((OpenGlToolkit) ((Class286) this).aHa_Sub2_3684).anInt7788
		       == 2147483647)
    ...
    Class286_Sub1(OpenGlToolkit var_ha_Sub2) {
	super(var_ha_Sub2);
	...
	if (class258 == null) {
		...
		((Class286) this).aHa_Sub2_3684.method3771
		    ((byte) -114, (((OpenGlToolkit) ((Class286) this).aHa_Sub2_3684)
				   .aClass258_Sub3_7827));
