...
final class Class206 implements Interface11
{
    ...
    private OpenGlToolkit aHa_Sub2_4883;
	...
	anInt4890++;
	if (EntityPacket.aBoolean1236 && !Class167.method1296(true)) {
		...
		= Class286_Sub3.createBufferedPacket(OpenGlToolkit.aClass351_7554,
					   Class348_Sub23_Sub2.outgoingGameIsaac);
	    ((BufferedPacket) class348_sub47).buffer
		.putInt(RequiredElement.anInt3428);
	    Class348_Sub42_Sub14.queuePacket(-54, class348_sub47);
	    RequiredElement.anInt3428 = -1;
	}
    }
    ...
    Class206(OpenGlToolkit var_ha_Sub2) {
	anInt4872 = 0;
	anInt4873 = -1;
	if (!((OpenGlToolkit) var_ha_Sub2).aBoolean7820)
