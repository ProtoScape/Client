...
final class Class237_Sub1 extends MapLoader
{
	...
	do {
		...
		if (!((MapLoader) this).aBoolean3109) {
			...
			if ((i_42_ ^ 0xffffffff) == -1)
				...
				is[1] = class348_sub49.getWord(13638);
				is[2] = class348_sub49.getWord(13638);
				is[3] = class348_sub49.getWord(13638);
	...
	try {
		...
		int i_82_ = 0;
		for (;;) {
		    int i_83_ = class348_sub49.getSmartB();
		    if (i_83_ == 0)
			break;
		    i_82_ += -1 + i_83_;
	...
	try {
		...
		for (;;) {
		    ...
		    int i_103_ = 0;
		    for (;;) {
			int i_104_ = class348_sub49.getSmartB();
