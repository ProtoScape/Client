...
final class Class286_Sub4 extends Class286
{
    ...
    static GamePacket aClass351_6244 = new GamePacket(9, 8);
	...
	if (aBoolean6237 && class258_sub2 != null) {
	    float f
		= 2.0F * (-Math.abs(((OpenGlToolkit) ((Class286) this).aHa_Sub2_3684)
				    .aFloatArray7825[1])
			  + 1.0F) + 1.0F;
	    ((Class286) this).aHa_Sub2_3684.method3738(-15039, 1);
		...
		(OpenGL.glGetUniformLocationARB(l, "sunColour"),
		 ((OpenGlToolkit) ((Class286) this).aHa_Sub2_3684).aFloat7781 * f,
		 ((OpenGlToolkit) ((Class286) this).aHa_Sub2_3684).aFloat7816 * f,
		 ((OpenGlToolkit) ((Class286) this).aHa_Sub2_3684).aFloat7823 * f,
		 1.0F);
	    OpenGL.glUniform1fARB
		(OpenGL.glGetUniformLocationARB(l, "sunExponent"),
		 64.0F + 928.0F * Math.abs(((OpenGlToolkit)
